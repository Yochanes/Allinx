...
public final class ReorderableState$Companion$EaseOutQuadInterpolator$1 extends Lambda implements Function1<Float, Float> {
    ...
    public static final ReorderableState$Companion$EaseOutQuadInterpolator$1 f58118a = new ReorderableState$Companion$EaseOutQuadInterpolator$1(1);

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        float f = 1;
        float fFloatValue = f - ((Number) obj).floatValue();
        return Float.valueOf(f - (((fFloatValue * fFloatValue) * fFloatValue) * fFloatValue));
    }
}
