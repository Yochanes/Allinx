...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C48011();
    ...
    /* JADX INFO: renamed from: com.google.gson.internal.LinkedTreeMap$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C48011 implements Comparator<Comparable> {
    ...
    public class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        /* JADX INFO: compiled from: Proguard */
        public class C48021 extends LinkedTreeMap<K, V>.LinkedTreeMapIterator<Map.Entry<K, V>> {
            public C48021() {
                super();
            }
    ...
    public final class KeySet extends AbstractSet<K> {
        ...
        /* JADX INFO: compiled from: Proguard */
        public class C48031 extends LinkedTreeMap<K, V>.LinkedTreeMapIterator<K> {
            public C48031() {
                super();
            }
