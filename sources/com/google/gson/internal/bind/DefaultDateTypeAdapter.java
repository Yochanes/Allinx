...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    public static final TypeAdapterFactory DEFAULT_STYLE_FACTORY = new C48151();
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C48151 implements TypeAdapterFactory {
        @Override // com.google.gson.TypeAdapterFactory
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
            if (typeToken.getRawType() == Date.class) {
                return new DefaultDateTypeAdapter(DateType.DATE, 2, 2, null);
            }
            return null;
        }
    ...
    public static abstract class DateType<T extends Date> {
        public static final DateType<Date> DATE = new C48161(Date.class);
        ...
        public final TypeAdapterFactory createAdapterFactory(String str) {
            return createFactory(new DefaultDateTypeAdapter<>(this, str, (C48151) null));
        }
        ...
        /* JADX INFO: compiled from: Proguard */
        public class C48161 extends DateType<Date> {
            public C48161(Class cls) {
                super(cls);
            }
    ...
    public /* synthetic */ DefaultDateTypeAdapter(DateType dateType, int i, int i2, C48151 c48151) {
        this(dateType, i, i2);
    }
        ...
        synchronized (this.dateFormats) {
            try {
                ...
                try {
                    ...
                    StringBuilder sbM23t = AbstractC0000a.m23t("Failed parsing '", strNextString, "' as Date; at path ");
                    sbM23t.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbM23t.toString(), e);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public /* synthetic */ DefaultDateTypeAdapter(DateType dateType, String str, C48151 c48151) {
        this(dateType, str);
    }
