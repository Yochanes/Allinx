...
public final class JsonTreeReader extends JsonReader {
    ...
    private static final Reader UNREADABLE_READER = new C48201();
    private static final Object SENTINEL_CLOSED = new Object();

    /* JADX INFO: renamed from: com.google.gson.internal.bind.JsonTreeReader$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C48201 extends Reader {
    ...
    /* JADX INFO: compiled from: Proguard */
    public static /* synthetic */ class C48212 {
    ...
    public void skipValue() throws MalformedJsonException {
        int i = C48212.$SwitchMap$com$google$gson$stream$JsonToken[peek().ordinal()];
        if (i == 1) {
            nextName(true);
            return;
        }
