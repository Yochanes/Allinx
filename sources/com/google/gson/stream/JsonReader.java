...
public class JsonReader implements Closeable {
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C48701 extends JsonReaderInternalAccess {
        ...
        public void promoteNameToValue(JsonReader jsonReader) throws IOException {
            ...
            if (iDoPeek == 13) {
                ...
                if (iDoPeek != 14) {
                    throw JsonReader.access$000(jsonReader, "a name");
                }
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new C48701();
    }
    ...
    public JsonReader(Reader reader) {
        ...
        this.f42880in = reader;
    }

    public static /* synthetic */ IllegalStateException access$000(JsonReader jsonReader, String str) {
        return jsonReader.unexpectedTokenError(str);
    }
        ...
        while (true) {
            ...
            switch (i3) {
                ...
                case 8:
                    break;
                default:
                    throw new AssertionError(AbstractC0000a.m9f(i3, "Unknown scope value: "));
            }
            i++;
        }
    }
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private String nextQuotedValue(char c2) throws MalformedJsonException {
        char[] cArr = this.buffer;
        ...
        do {
            ...
            while (true) {
                ...
                while (i < i3) {
                    int i5 = i + 1;
                    char c3 = cArr[i];
                    if (this.strictness == Strictness.STRICT && c3 < ' ') {
    ...
    */
    ...
    private int peekKeyword() {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (c3 != str.charAt(i2) && (!z2 || c3 != str2.charAt(i2))) {
                return 0;
            }
        }
    ...
    */
    ...
    private MalformedJsonException syntaxError(String str) throws MalformedJsonException {
        ...
        sbM2244s.append(locationString());
        sbM2244s.append("\nSee ");
        sbM2244s.append(TroubleshootingGuide.createUrl("malformed-json"));
        throw new MalformedJsonException(sbM2244s.toString());
    }

    private IllegalStateException unexpectedTokenError(String str) {
        String str2 = peek() == JsonToken.NULL ? "adapter-not-null-safe" : "unexpected-json-structure";
        StringBuilder sbM23t = AbstractC0000a.m23t("Expected ", str, " but was ");
        sbM23t.append(peek());
        sbM23t.append(locationString());
        sbM23t.append("\nSee ");
        sbM23t.append(TroubleshootingGuide.createUrl(str2));
        return new IllegalStateException(sbM23t.toString());
    }
    ...
    public String locationString() {
        StringBuilder sbM24u = AbstractC0000a.m24u(" at line ", " column ", " path ", this.lineNumber + 1, (this.pos - this.lineStart) + 1);
        sbM24u.append(getPath());
    ...
    public final void setNestingLimit(int i) {
        if (i < 0) {
            throw new IllegalArgumentException(AbstractC0000a.m9f(i, "Invalid nesting limit: "));
        }
        this.nestingLimit = i;
    }
