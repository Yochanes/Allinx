...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    /* JADX INFO: compiled from: Proguard */
    public static /* synthetic */ class C48961 {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(C48961 c48961) {
            this();
        }
    ...
    private static void checkFieldNumber(int i) {
        if (i <= 0) {
            throw new IllegalArgumentException(AbstractC0000a.m9f(i, "fieldNumber must be positive: "));
        }
    }

    public static FieldInfo forExplicitPresenceField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i2, boolean z2, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        ...
        throw new IllegalArgumentException(AbstractC0000a.m9f(i2, "presenceMask must have exactly one bit set: "));
    }
    ...
    public static FieldInfo forLegacyRequiredField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i2, boolean z2, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
    ...
    public Class<?> getMessageFieldClass() {
        int i = C48961.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
