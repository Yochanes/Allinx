...
public final class FieldType {
    ...
    /* JADX INFO: renamed from: com.google.protobuf.FieldType$1 */
    /* JADX INFO: compiled from: Proguard */
    public static /* synthetic */ class C48991 {
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f42892id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C48991.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i4 == 1 || i4 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C48991.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : true;
    }
