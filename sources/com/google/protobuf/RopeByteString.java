...
final class RopeByteString extends ByteString {
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C49181 extends ByteString.AbstractByteIterator {
    ...
    public static final class PieceIterator implements Iterator<ByteString.LeafByteString> {
        ...
        public /* synthetic */ PieceIterator(ByteString byteString, C49181 c49181) {
            this(byteString);
        }
    ...
    public /* synthetic */ RopeByteString(ByteString byteString, ByteString byteString2, C49181 c49181) {
    ...
    public static ByteString concatenate(ByteString byteString, ByteString byteString2) {
        ...
        return size >= minLength(Math.max(byteString.getTreeDepth(), byteString2.getTreeDepth()) + 1) ? new RopeByteString(byteString, byteString2) : Balancer.access$100(new Balancer(null), byteString, byteString2);
    }
    ...
    public static class Balancer {
        ...
        public static /* synthetic */ ByteString access$100(Balancer balancer, ByteString byteString, ByteString byteString2) {
            return balancer.balance(byteString, byteString2);
        }
        ...
        private void insert(ByteString byteString) {
            ...
            ByteString byteStringPop = this.prefixesStack.pop();
            while (!this.prefixesStack.isEmpty() && this.prefixesStack.peek().size() < iMinLength2) {
                byteStringPop = new RopeByteString(this.prefixesStack.pop(), byteStringPop, null);
            }
            RopeByteString ropeByteString = new RopeByteString(byteStringPop, byteString, null);
            while (!this.prefixesStack.isEmpty()) {
        ...
        public /* synthetic */ Balancer(C49181 c49181) {
            this();
        }
    }
