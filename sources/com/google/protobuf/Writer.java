...
interface Writer {
    ...
    void writeBoolList(int i, List<Boolean> list, boolean z2);
    ...
    void writeDoubleList(int i, List<Double> list, boolean z2);
    ...
    void writeEnumList(int i, List<Integer> list, boolean z2);

    void writeFixed32(int i, int i2);

    void writeFixed32List(int i, List<Integer> list, boolean z2);

    void writeFixed64(int i, long j);

    void writeFixed64List(int i, List<Long> list, boolean z2);

    void writeFloat(int i, float f);

    void writeFloatList(int i, List<Float> list, boolean z2);
    ...
    void writeInt32List(int i, List<Integer> list, boolean z2);

    void writeInt64(int i, long j);

    void writeInt64List(int i, List<Long> list, boolean z2);
    ...
    void writeSFixed32List(int i, List<Integer> list, boolean z2);

    void writeSFixed64(int i, long j);

    void writeSFixed64List(int i, List<Long> list, boolean z2);

    void writeSInt32(int i, int i2);

    void writeSInt32List(int i, List<Integer> list, boolean z2);

    void writeSInt64(int i, long j);

    void writeSInt64List(int i, List<Long> list, boolean z2);
    ...
    void writeUInt32List(int i, List<Integer> list, boolean z2);

    void writeUInt64(int i, long j);

    void writeUInt64List(int i, List<Long> list, boolean z2);
}
