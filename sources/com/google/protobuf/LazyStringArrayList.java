...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    public static class ByteArrayListView extends AbstractList<byte[]> implements RandomAccess {
        ...
        public byte[] remove(int i) {
            ...
            ((AbstractList) this).modCount++;
            return LazyStringArrayList.access$100(strRemove);
        }

        public byte[] set(int i, byte[] bArr) {
            Object objAccess$000 = LazyStringArrayList.access$000(this.list, i, bArr);
            ((AbstractList) this).modCount++;
            return LazyStringArrayList.access$100(objAccess$000);
        }
    }
    ...
    public static class ByteStringListView extends AbstractList<ByteString> implements RandomAccess {
        ...
        public ByteString remove(int i) {
            String strRemove = this.list.remove(i);
            ((AbstractList) this).modCount++;
            return LazyStringArrayList.access$400(strRemove);
        }

        public ByteString set(int i, ByteString byteString) {
            Object objAccess$300 = LazyStringArrayList.access$300(this.list, i, byteString);
            ((AbstractList) this).modCount++;
            return LazyStringArrayList.access$400(objAccess$300);
        }
    }
