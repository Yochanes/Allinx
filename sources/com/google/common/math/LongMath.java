...
public final class LongMath {
    ...
    @VisibleForTesting
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f42543SI, Ascii.f42543SI, Ascii.f42543SI, Ascii.f42543SI, Ascii.f42544SO, Ascii.f42544SO, Ascii.f42544SO, Ascii.f42534CR, Ascii.f42534CR, Ascii.f42534CR, Ascii.f42536FF, Ascii.f42536FF, Ascii.f42536FF, Ascii.f42536FF, Ascii.f42547VT, Ascii.f42547VT, Ascii.f42547VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, 169, 143, 125, 111, MTObservable.WHAT_OBSERVER, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    ...
    public static abstract class MillerRabinTester {
        public static final MillerRabinTester SMALL = new C44731("SMALL", 0);
        public static final MillerRabinTester LARGE = new C44742("LARGE", 1);
        private static final /* synthetic */ MillerRabinTester[] $VALUES = $values();

        /* JADX INFO: renamed from: com.google.common.math.LongMath$MillerRabinTester$1 */
        /* JADX INFO: compiled from: Proguard */
        public enum C44731 extends MillerRabinTester {
            public C44731(String str, int i) {
                super(str, i, null);
            }
        ...
        /* JADX INFO: renamed from: com.google.common.math.LongMath$MillerRabinTester$2 */
        /* JADX INFO: compiled from: Proguard */
        public enum C44742 extends MillerRabinTester {
            public C44742(String str, int i) {
                super(str, i, null);
            }
        ...
        public /* synthetic */ MillerRabinTester(String str, int i, C44721 c44721) {
            this(str, i);
        }
    }
    ...
    public static long divide(long j, long j2, RoundingMode roundingMode) {
        ...
        int i = ((int) ((j ^ j2) >> 63)) | 1;
        switch (C44721.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        double d = j;
        long j3 = (long) d;
        int iCompare = j3 == Long.MAX_VALUE ? -1 : Long.compare(j, j3);
        int[] iArr = C44721.$SwitchMap$java$math$RoundingMode;
