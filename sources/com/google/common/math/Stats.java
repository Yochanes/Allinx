...
public final class Stats implements Serializable {
    ...
    public static Stats m15031of(Iterable<? extends Number> iterable) {
    ...
    public String toString() {
        return count() > 0 ? MoreObjects.toStringHelper(this).add(MTPushConstants.Geofence.KEY_COUNT, this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add("min", this.min).add("max", this.max).toString() : MoreObjects.toStringHelper(this).add(MTPushConstants.Geofence.KEY_COUNT, this.count).toString();
    }
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m15032of(Iterator<? extends Number> it) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m15033of(double... dArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m15034of(int... iArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m15035of(long... jArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
