...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public static class AsList extends AbstractList<Double> implements RandomAccess, Serializable {
        ...
        public /* synthetic */ AsList(ImmutableDoubleArray immutableDoubleArray, C44781 c44781) {
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            int iAccess$100 = ImmutableDoubleArray.access$100(this.parent);
            for (Object obj2 : list) {
                if (obj2 instanceof Double) {
                    int i = iAccess$100 + 1;
                    if (ImmutableDoubleArray.access$500(ImmutableDoubleArray.access$000(this.parent)[iAccess$100], ((Double) obj2).doubleValue())) {
                        iAccess$100 = i;
                    }
                }
                return false;
    ...
    public /* synthetic */ ImmutableDoubleArray(double[] dArr, int i, int i2, C44781 c44781) {
        this(dArr, i, i2);
    }
    ...
    public static ImmutableDoubleArray m15038of() {
        return EMPTY;
    }
    ...
    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m15039of(double d) {
    ...
    public static final class Builder {
        ...
        public ImmutableDoubleArray build() {
            return this.count == 0 ? ImmutableDoubleArray.access$200() : new ImmutableDoubleArray(this.array, 0, this.count, null);
        }
    ...
    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m15040of(double d, double d2) {
    ...
    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m15041of(double d, double d2, double d3) {
    ...
    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m15042of(double d, double d2, double d3, double d4) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m15043of(double d, double d2, double d3, double d4, double d5) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m15044of(double d, double d2, double d3, double d4, double d5, double d6) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5, d6});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m15045of(double d, double... dArr) {
