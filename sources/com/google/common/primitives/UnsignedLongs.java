...
public final class UnsignedLongs {
    ...
    public static long decode(String str) {
        ...
        try {
            ...
            NumberFormatException numberFormatException = new NumberFormatException(AbstractC0000a.m13j("Error parsing value: ", str));
    ...
    public static long parseUnsignedLong(String str, int i) {
        ...
        if (i < 2 || i > 36) {
            throw new NumberFormatException(AbstractC0000a.m9f(i, "illegal radix: "));
        }
