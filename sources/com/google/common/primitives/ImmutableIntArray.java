...
public final class ImmutableIntArray implements Serializable {
    ...
    public static class AsList extends AbstractList<Integer> implements RandomAccess, Serializable {
        ...
        public /* synthetic */ AsList(ImmutableIntArray immutableIntArray, C44791 c44791) {
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            int iAccess$100 = ImmutableIntArray.access$100(this.parent);
            for (Object obj2 : list) {
                if (obj2 instanceof Integer) {
                    int i = iAccess$100 + 1;
                    if (ImmutableIntArray.access$000(this.parent)[iAccess$100] == ((Integer) obj2).intValue()) {
                        iAccess$100 = i;
                    }
                }
                return false;
    ...
    public /* synthetic */ ImmutableIntArray(int[] iArr, int i, int i2, C44791 c44791) {
        this(iArr, i, i2);
    }
    ...
    public static ImmutableIntArray m15046of() {
        return EMPTY;
    }
    ...
    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m15047of(int i) {
    ...
    public static final class Builder {
        ...
        public ImmutableIntArray build() {
            return this.count == 0 ? ImmutableIntArray.access$200() : new ImmutableIntArray(this.array, 0, this.count, null);
        }
    ...
    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m15048of(int i, int i2) {
        return new ImmutableIntArray(new int[]{i, i2});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m15049of(int i, int i2, int i3) {
        return new ImmutableIntArray(new int[]{i, i2, i3});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m15050of(int i, int i2, int i3, int i4) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m15051of(int i, int i2, int i3, int i4, int i5) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m15052of(int i, int i2, int i3, int i4, int i5, int i6) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5, i6});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m15053of(int i, int... iArr) {
