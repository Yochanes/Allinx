...
public final class Booleans {
    ...
    public static class BooleanArrayAsList extends AbstractList<Boolean> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            return (obj instanceof Boolean) && Booleans.access$000(this.array, ((Boolean) obj).booleanValue(), this.start, this.end) != -1;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int iAccess$000;
            if (!(obj instanceof Boolean) || (iAccess$000 = Booleans.access$000(this.array, ((Boolean) obj).booleanValue(), this.start, this.end)) < 0) {
                return -1;
            }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int iAccess$100;
            if (!(obj instanceof Boolean) || (iAccess$100 = Booleans.access$100(this.array, ((Boolean) obj).booleanValue(), this.start, this.end)) < 0) {
                return -1;
            }
    ...
    public static /* synthetic */ int access$000(boolean[] zArr, boolean z2, int i, int i2) {
        return indexOf(zArr, z2, i, i2);
    }

    public static /* synthetic */ int access$100(boolean[] zArr, boolean z2, int i, int i2) {
        return lastIndexOf(zArr, z2, i, i2);
    }
    ...
    private static int indexOf(boolean[] zArr, boolean z2, int i, int i2) {
        while (i < i2) {
            if (zArr[i] == z2) {
                return i;
            }
    ...
    private static int lastIndexOf(boolean[] zArr, boolean z2, int i, int i2) {
