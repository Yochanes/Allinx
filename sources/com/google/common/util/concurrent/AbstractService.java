...
public abstract class AbstractService implements Service {
    ...
    private static final ListenerCallQueue.Event<Service.Listener> STARTING_EVENT = new C45181();
    private static final ListenerCallQueue.Event<Service.Listener> RUNNING_EVENT = new C45192();
    ...
    /* JADX INFO: renamed from: com.google.common.util.concurrent.AbstractService$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C45181 implements ListenerCallQueue.Event<Service.Listener> {
    ...
    /* JADX INFO: renamed from: com.google.common.util.concurrent.AbstractService$2 */
    /* JADX INFO: compiled from: Proguard */
    public class C45192 implements ListenerCallQueue.Event<Service.Listener> {
        @Override // com.google.common.util.concurrent.ListenerCallQueue.Event
        public /* bridge */ /* synthetic */ void call(Service.Listener listener) {
            call2(listener);
        }
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C45203 implements ListenerCallQueue.Event<Service.Listener> {
        final /* synthetic */ Service.State val$from;

        public C45203(Service.State state) {
            this.val$from = state;
        }
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C45214 implements ListenerCallQueue.Event<Service.Listener> {
        final /* synthetic */ Service.State val$from;

        public C45214(Service.State state) {
            this.val$from = state;
        }
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C45225 implements ListenerCallQueue.Event<Service.Listener> {
        final /* synthetic */ AbstractService this$0;
        final /* synthetic */ Throwable val$cause;
        final /* synthetic */ Service.State val$from;

        public C45225(AbstractService abstractService, Service.State state, Throwable th) {
            this.val$from = state;
            this.val$cause = th;
    ...
    /* JADX INFO: compiled from: Proguard */
    public static /* synthetic */ class C45236 {
    ...
    public static final class StateSnapshot {
        ...
        public StateSnapshot(Service.State state, boolean z2, @CheckForNull Throwable th) {
    ...
    private void enqueueFailedEvent(Service.State state, Throwable th) {
        this.listeners.enqueue(new C45225(this, state, th));
    }
    ...
    private void enqueueTerminatedEvent(Service.State state) {
        switch (C45236.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
            case 1:
    ...
    public final void notifyFailed(Throwable th) {
        ...
        try {
            ...
            int i = C45236.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
