...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    public static /* synthetic */ EndpointPair m14989a(Object obj, Object obj2) {
    ...
    public static <N, V> UndirectedGraphConnections<N, V> m14990of(ElementOrder<N> elementOrder) {
        int i = C44151.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
    ...
    public Iterator<EndpointPair<N>> incidentEdgeIterator(N n) {
        return Iterators.transform(this.adjacentNodeValues.keySet().iterator(), new C4424h(n, 3));
    }
