...
class FilteredEntryMultimap<K, V> extends AbstractMultimap<K, V> implements FilteredMultimap<K, V> {
    ...
    public class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        public class C1EntrySetImpl extends Maps.EntrySet<K, Collection<V>> {
            ...
            /* JADX INFO: compiled from: Proguard */
            public class C41921 extends AbstractIterator<Map.Entry<K, Collection<V>>> {
            ...
            public boolean removeAll(Collection<?> collection) {
                return FilteredEntryMultimap.this.removeEntriesIf(Predicates.m14763in(collection));
            }

            @Override // com.google.common.collect.Maps.EntrySet, com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> collection) {
                return FilteredEntryMultimap.this.removeEntriesIf(Predicates.not(Predicates.m14763in(collection)));
            }
        ...
        public class C1KeySetImpl extends Maps.KeySet<K, Collection<V>> {
            ...
            public boolean removeAll(Collection<?> collection) {
                return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.m14763in(collection)));
            }

            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> collection) {
                return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m14763in(collection))));
            }
        }

        /* JADX INFO: renamed from: com.google.common.collect.FilteredEntryMultimap$AsMap$1ValuesImpl, reason: invalid class name */
        /* JADX INFO: compiled from: Proguard */
        public class C1ValuesImpl extends Maps.Values<K, Collection<V>> {
            ...
            @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean removeAll(Collection<?> collection) {
                return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.m14763in(collection)));
            }

            @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean retainAll(Collection<?> collection) {
                return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m14763in(collection))));
            }
        }
        ...
        public Set<K> createKeySet() {
            return new C1KeySetImpl();
        }

        @Override // com.google.common.collect.Maps.ViewCachingAbstractMap
        public Collection<Collection<V>> createValues() {
            return new C1ValuesImpl();
        }
    ...
    public class Keys extends Multimaps.Keys<K, V> {
        ...
        /* JADX INFO: compiled from: Proguard */
        public class C41931 extends Multisets.EntrySet<K> {
            public C41931() {
            }

            /* JADX INFO: renamed from: a */
            public static /* synthetic */ boolean m14808a(Predicate predicate, Map.Entry entry) {
                return lambda$removeEntriesIf$0(predicate, entry);
            }
            ...
            private boolean removeEntriesIf(Predicate<? super Multiset.Entry<K>> predicate) {
                return FilteredEntryMultimap.this.removeEntriesIf(new C4366n(predicate));
            }
            ...
            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean removeAll(Collection<?> collection) {
                return removeEntriesIf(Predicates.m14763in(collection));
            }

            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> collection) {
                return removeEntriesIf(Predicates.not(Predicates.m14763in(collection)));
            }
    ...
    public final class ValuePredicate implements Predicate<V> {
        ...
        public boolean apply(@ParametricNullness V v) {
            return FilteredEntryMultimap.access$000(FilteredEntryMultimap.this, this.key, v);
        }
    }
