...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C42021 extends UnmodifiableIterator<K> {
        final /* synthetic */ ImmutableMap this$0;
        final /* synthetic */ UnmodifiableIterator val$entryIterator;

        public C42021(ImmutableMap immutableMap, UnmodifiableIterator unmodifiableIterator) {
    ...
    public static abstract class IteratorBasedImmutableMap<K, V> extends ImmutableMap<K, V> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.ImmutableMap$IteratorBasedImmutableMap$1EntrySetImpl, reason: invalid class name */
        /* JADX INFO: compiled from: Proguard */
    ...
    public final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
        ...
        /* JADX INFO: compiled from: Proguard */
        public class C42031 extends UnmodifiableIterator<Map.Entry<K, ImmutableSet<V>>> {
            ...
            public class AnonymousClass1 extends AbstractMapEntry<K, ImmutableSet<V>> {
                final /* synthetic */ C42031 this$2;
                final /* synthetic */ Map.Entry val$backingEntry;

                public AnonymousClass1(C42031 c42031, Map.Entry entry) {
                ...
                public ImmutableSet<V> getValue() {
                    return ImmutableSet.m14873of(this.val$backingEntry.getValue());
                }
            }

            public C42031(MapViewOfValuesAsSingletonSets mapViewOfValuesAsSingletonSets, Iterator it) {
            ...
            public Map.Entry<K, ImmutableSet<V>> next() {
                return new AnonymousClass1(this, (Map.Entry) this.val$backingIterator.next());
            }
        }
        ...
        public UnmodifiableIterator<Map.Entry<K, ImmutableSet<V>>> entryIterator() {
            return new C42031(this, ImmutableMap.this.entrySet().iterator());
        }
        ...
        public /* synthetic */ MapViewOfValuesAsSingletonSets(ImmutableMap immutableMap, C42021 c42021) {
            this();
        }
        ...
        public ImmutableSet<V> get(@CheckForNull Object obj) {
            ...
            return ImmutableSet.m14873of(obj2);
        }
    }
    ...
    public static <K, V> ImmutableMap<K, V> m14843of() {
    ...
    public UnmodifiableIterator<K> keyIterator() {
        return new C42021(this, entrySet().iterator());
    }
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14844of(K k, V v) {
        CollectPreconditions.checkEntryNotNull(k, v);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14845of(K k, V v, K k2, V v2) {
        CollectPreconditions.checkEntryNotNull(k, v);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14846of(K k, V v, K k2, V v2, K k3, V v3) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14847of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14848of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14849of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14850of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14851of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14852of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m14853of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
