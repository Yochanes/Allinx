...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    public static class Builder<E> extends ImmutableCollection.ArrayBasedBuilder<E> {
        ...
        public Builder(int i, boolean z2) {
            super(i);
            if (z2) {
        ...
        public ImmutableSet<E> build() {
            ImmutableSet<E> immutableSetAccess$100;
            int i = this.size;
            if (i == 0) {
            ...
            if (i == 1) {
                ...
                Objects.requireNonNull(obj);
                return ImmutableSet.m14873of(obj);
            }
            if (this.hashTable == null || ImmutableSet.chooseTableSize(i) != this.hashTable.length) {
                immutableSetAccess$100 = ImmutableSet.access$100(this.size, this.contents);
                this.size = immutableSetAccess$100.size();
            } else {
                Object[] objArrCopyOf = ImmutableSet.access$000(this.size, this.contents.length) ? Arrays.copyOf(this.contents, this.size) : this.contents;
                immutableSetAccess$100 = new RegularImmutableSet<>(objArrCopyOf, this.hashCode, this.hashTable, r5.length - 1, this.size);
            }
            this.forceCopy = true;
            this.hashTable = null;
            return immutableSetAccess$100;
        }
    ...
    public static /* synthetic */ ImmutableSet access$100(int i, Object[] objArr) {
    ...
    public static <E> ImmutableSet<E> m14872of() {
    ...
    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m14873of(E e) {
        return new SingletonImmutableSet(e);
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m14874of(E e, E e2) {
        return construct(2, e, e2);
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m14875of(E e, E e2, E e3) {
        return construct(3, e, e2, e3);
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m14876of(E e, E e2, E e3, E e4) {
    ...
    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m14877of(E e, E e2, E e3, E e4, E e5) {
        return construct(5, e, e2, e3, e4, e5);
    }

    @SafeVarargs
    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m14878of(E e, E e2, E e3, E e4, E e5, E e6, E... eArr) {
