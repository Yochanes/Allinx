...
public final class Strings {
    ...
    private static String lenientToString(@CheckForNull Object obj) {
        ...
        try {
            ...
            StringBuilder sbM23t = AbstractC0000a.m23t("<", str, " threw ");
            sbM23t.append(e.getClass().getName());
            sbM23t.append(">");
    ...
    public static String repeat(String str, int i) {
        ...
        int i2 = (int) j;
        if (i2 != j) {
            throw new ArrayIndexOutOfBoundsException(AbstractC0455a.m2238m(j, "Required array size too large: "));
        }
