...
public final class Preconditions {
    ...
    private static String badElementIndex(int i, int i2, String str) {
        ...
        throw new IllegalArgumentException(AbstractC0000a.m9f(i2, "negative size: "));
    }
    ...
    public static void checkArgument(boolean z2, String str, char c2, int i) {
        if (!z2) {
    ...
    public static void checkState(boolean z2, String str, char c2, int i) {
        if (!z2) {
            throw new IllegalStateException(Strings.lenientFormat(str, Character.valueOf(c2), Integer.valueOf(i)));
        }
    }

    public static void checkArgument(boolean z2, String str, char c2, long j) {
        if (!z2) {
    ...
    public static void checkState(boolean z2, String str, char c2, long j) {
        if (!z2) {
    ...
    public static void checkArgument(boolean z2, String str, int i, char c2) {
        if (!z2) {
    ...
    public static void checkState(boolean z2, String str, int i, char c2) {
        if (!z2) {
    ...
    public static void checkArgument(boolean z2, String str, int i, @CheckForNull Object obj) {
        if (!z2) {
    ...
    public static void checkState(boolean z2, String str, int i, @CheckForNull Object obj) {
        if (!z2) {
            throw new IllegalStateException(Strings.lenientFormat(str, Integer.valueOf(i), obj));
        }
    }

    public static void checkArgument(boolean z2, String str, long j, char c2) {
        if (!z2) {
    ...
    public static void checkState(boolean z2, String str, long j, char c2) {
        if (!z2) {
    ...
    public static void checkArgument(boolean z2, String str, long j, @CheckForNull Object obj) {
        if (!z2) {
    ...
    public static void checkState(boolean z2, String str, long j, @CheckForNull Object obj) {
        if (!z2) {
    ...
    public static void checkArgument(boolean z2, String str, @CheckForNull Object obj, int i) {
        if (!z2) {
    ...
    public static void checkState(boolean z2, String str, @CheckForNull Object obj, int i) {
        if (!z2) {
            throw new IllegalStateException(Strings.lenientFormat(str, obj, Integer.valueOf(i)));
        }
    }

    public static void checkArgument(boolean z2, String str, @CheckForNull Object obj, long j) {
        if (!z2) {
    ...
    public static void checkState(boolean z2, String str, @CheckForNull Object obj, long j) {
        if (!z2) {
