...
public abstract class UPCEANReader extends OneDReader {
    ...
    public static int[] findGuardPattern(BitArray bitArray, int i, boolean z2, int[] iArr) {
        return findGuardPattern(bitArray, i, z2, iArr, new int[iArr.length]);
    }
    ...
    private static int[] findGuardPattern(BitArray bitArray, int i, boolean z2, int[] iArr, int[] iArr2) throws NotFoundException {
        int size = bitArray.getSize();
        int nextUnset = z2 ? bitArray.getNextUnset(i) : bitArray.getNextSet(i);
