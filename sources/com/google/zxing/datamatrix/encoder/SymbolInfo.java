...
public class SymbolInfo {
    ...
    public SymbolInfo(boolean z2, int i, int i2, int i3, int i4, int i5) {
        this(z2, i, i2, i3, i4, i5, i, i2);
    }
    ...
    public SymbolInfo(boolean z2, int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        this.rectangular = z2;
        this.dataCapacity = i;
    ...
    public static SymbolInfo lookup(int i, boolean z2, boolean z3) {
        return lookup(i, z2 ? SymbolShapeHint.FORCE_NONE : SymbolShapeHint.FORCE_SQUARE, z3);
    }

    private static SymbolInfo lookup(int i, SymbolShapeHint symbolShapeHint, boolean z2) {
        return lookup(i, symbolShapeHint, null, null, z2);
    }

    public static SymbolInfo lookup(int i, SymbolShapeHint symbolShapeHint, Dimension dimension, Dimension dimension2, boolean z2) {
        ...
        if (z2) {
            throw new IllegalArgumentException(AbstractC0000a.m9f(i, "Can't find a symbol arrangement that matches the message. Data codewords: "));
        }
        return null;
    }
}
