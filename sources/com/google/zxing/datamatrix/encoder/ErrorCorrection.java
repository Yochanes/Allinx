...
public final class ErrorCorrection {
    ...
    private static String createECCBlock(CharSequence charSequence, int i) {
        ...
        if (i4 < 0) {
            throw new IllegalArgumentException(AbstractC0000a.m9f(i, "Illegal number of error correction codewords specified: "));
        }
