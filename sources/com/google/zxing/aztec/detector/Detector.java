...
public final class Detector {
    ...
    public static final class Point {
        ...
        private final int f42911x;

        /* JADX INFO: renamed from: y */
        private final int f42912y;
        ...
        public ResultPoint toResultPoint() {
            return new ResultPoint(this.f42911x, this.f42912y);
        }

        public String toString() {
            StringBuilder sb = new StringBuilder("<");
            sb.append(this.f42911x);
            sb.append(' ');
            return AbstractC0000a.m17n(sb, this.f42912y, '>');
        }
    }
    ...
    private static ResultPoint[] expandSquare(ResultPoint[] resultPointArr, int i, int i2) {
        ...
        float f2 = x * f;
        float f3 = y2 * f;
        ResultPoint resultPoint = new ResultPoint(x2 + f2, y3 + f3);
        ResultPoint resultPoint2 = new ResultPoint(x2 - f2, y3 - f3);
        ...
        float f4 = x3 * f;
        float f5 = f * y4;
        return new ResultPoint[]{resultPoint, new ResultPoint(x4 + f4, y5 + f5), resultPoint2, new ResultPoint(x4 - f4, y5 - f5)};
    }
    ...
    private static CorrectedParameter getCorrectedParameterData(long j, boolean z2) throws NotFoundException {
        int i;
        int i2;
        if (z2) {
            i = 7;
    ...
    private Point getFirstDifferent(Point point, boolean z2, int i, int i2) {
        int x = point.getX() + i;
        int y2 = point.getY();
        while (true) {
            y2 += i2;
        ...
        int i3 = x - i;
        int i4 = y2 - i2;
        while (isValid(i3, i4) && this.image.get(i3, i4) == z2) {
            i3 += i;
        }
        int i5 = i3 - i;
        while (isValid(i5, i4) && this.image.get(i5, i4) == z2) {
            i4 += i2;
        }
    ...
    private int sampleLine(ResultPoint resultPoint, ResultPoint resultPoint2, int i) {
        ...
        float y3 = ((resultPoint2.getY() - resultPoint.getY()) * f) / fDistance;
        int i2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
            float f2 = i3;
            if (this.image.get(MathUtils.round((f2 * x2) + x), MathUtils.round((f2 * y3) + y2))) {
                i2 |= 1 << ((i - i3) - 1);
            }
        }
        return i2;
