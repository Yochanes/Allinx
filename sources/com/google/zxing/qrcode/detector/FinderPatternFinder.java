...
public class FinderPatternFinder {
    ...
    private static final EstimatedModuleComparator moduleComparator = new EstimatedModuleComparator(null);
    ...
    public static final class EstimatedModuleComparator implements Comparator<FinderPattern>, Serializable {
        ...
        public /* synthetic */ EstimatedModuleComparator(C49661 c49661) {
            this();
        }
    ...
    */
    ...
    @Deprecated
    public final boolean handlePossibleCenter(int[] iArr, int i, int i2, boolean z2) {
