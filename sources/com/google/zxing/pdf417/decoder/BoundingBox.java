...
final class BoundingBox {
    ...
    */
    public BoundingBox addMissingRows(int i, int i2, boolean z2) {
        ...
        if (i > 0) {
            ResultPoint resultPoint9 = z2 ? resultPoint5 : resultPoint7;
            int y2 = ((int) resultPoint9.getY()) - i;
            if (y2 < 0) {
                y2 = 0;
            }
            ResultPoint resultPoint10 = new ResultPoint(resultPoint9.getX(), y2);
            if (!z2) {
                resultPoint2 = resultPoint10;
                resultPoint = resultPoint5;
                if (i2 <= 0) {
                    ResultPoint resultPoint11 = z2 ? this.bottomLeft : this.bottomRight;
                    int y3 = ((int) resultPoint11.getY()) + i2;
