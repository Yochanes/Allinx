...
/* JADX INFO: renamed from: com.google.accompanist.permissions.PermissionsUtilKt$PermissionsLifecycleCheckerEffect$1$invoke$$inlined$onDispose$1 */
...
public final class C3677xa2072dd0 implements DisposableEffectResult {
    final /* synthetic */ Lifecycle $lifecycle$inlined;
    final /* synthetic */ LifecycleEventObserver $permissionsCheckerObserver$inlined;

    public C3677xa2072dd0(Lifecycle lifecycle, LifecycleEventObserver lifecycleEventObserver) {
    ...
    public void dispose() {
        this.$lifecycle$inlined.mo9125c(this.$permissionsCheckerObserver$inlined);
    }
}
