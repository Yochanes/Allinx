...
/* JADX INFO: renamed from: com.google.accompanist.permissions.PermissionsUtilKt$PermissionLifecycleCheckerEffect$1$invoke$$inlined$onDispose$1 */
...
public final class C3674x65a426a5 implements DisposableEffectResult {
    final /* synthetic */ Lifecycle $lifecycle$inlined;
    final /* synthetic */ LifecycleEventObserver $permissionCheckerObserver$inlined;

    public C3674x65a426a5(Lifecycle lifecycle, LifecycleEventObserver lifecycleEventObserver) {
    ...
    public void dispose() {
        this.$lifecycle$inlined.mo9125c(this.$permissionCheckerObserver$inlined);
    }
}
