...
class MetaDataStore {
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C46641 extends JSONObject {
        final /* synthetic */ String val$userId;

        public C46641(String str) throws JSONException {
            this.val$userId = str;
    ...
    private static List<RolloutAssignment> jsonToRolloutsState(String str) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            try {
                ...
                Logger.getLogger().m15170w("Failed de-serializing rollouts state. " + string, e);
            }
        }
        return arrayList;
    }
    ...
    private static String rolloutsStateToJson(List<RolloutAssignment> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            try {
                ...
                Logger.getLogger().m15170w("Exception parsing rollout assignment!", e);
            }
        }
    ...
    private static void safeDeleteCorruptFile(File file) {
        if (file.exists() && file.delete()) {
            Logger.getLogger().m15165i("Deleted corrupt file: " + file.getAbsolutePath());
        }
    }

    private static String userIdToJson(String str) {
        return new C46641(str).toString();
    }
    ...
    public String readUserId(String str) throws Throwable {
                ...
                if (r3 != 0) {
                    try {
                        ...
                        try {
                            ...
                            Logger.getLogger().m15161d("Loaded userId " + strJsonToUserId + " for session " + str);
                            CommonUtils.closeOrLog(fileInputStream, "Failed to close user metadata file.");
                            return strJsonToUserId;
                        } catch (Exception e) {
                            e = e;
                            Logger.getLogger().m15170w("Error deserializing user metadata.", e);
        ...
        Logger.getLogger().m15161d("No userId set for session " + str);
        safeDeleteCorruptFile(userDataFileForSession);
        return null;
    }
    ...
    public void writeRolloutState(String str, List<RolloutAssignment> list) throws Throwable {
        ...
        try {
            ...
            Logger.getLogger().m15170w("Error serializing rollouts state.", e);
            safeDeleteCorruptFile(rolloutsStateForSession);
    ...
    public void writeUserData(String str, String str2) throws Throwable {
        ...
        try {
            ...
            e = e2;
            bufferedWriter2 = bufferedWriter;
            Logger.getLogger().m15170w("Error serializing user metadata.", e);
    ...
    public void writeKeyData(String str, Map<String, String> map, boolean z2) throws Throwable {
        ...
        try {
            ...
            e = e2;
            bufferedWriter2 = bufferedWriter;
            Logger.getLogger().m15170w("Error serializing key/value metadata.", e);
            safeDeleteCorruptFile(internalKeysFileForSession);
