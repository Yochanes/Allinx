...
public class FileStore {
    ...
    public static /* synthetic */ boolean m15200a(String str, File file, String str2) {
        return lambda$cleanupFileSystemDirs$0(str, file, str2);
    }

    private void cleanupFileSystemDir(String str) {
        File file = new File(this.filesDir, str);
        if (file.exists() && recursiveDelete(file)) {
            Logger.getLogger().m15161d("Deleted previous Crashlytics file system: " + file.getPath());
        }
    }

    private void cleanupFileSystemDirs(String str) {
        String[] list;
        if (!this.filesDir.exists() || (list = this.filesDir.list(new C4700b(str))) == null) {
            return;
        }
    ...
    private static /* synthetic */ boolean lambda$cleanupFileSystemDirs$0(String str, File file, String str2) {
    ...
    private static synchronized File prepareBaseDir(File file) {
        try {
            if (file.exists()) {
                ...
                Logger.getLogger().m15161d("Unexpected non-directory file: " + file + "; deleting file and creating new directory.");
                file.delete();
            }
            if (!file.mkdirs()) {
                Logger.getLogger().m15163e("Could not create Crashlytics-specific directory: " + file);
            }
            return file;
        } catch (Throwable th) {
            throw th;
