...
public class HttpGetRequest {
    ...
    private String createUrlWithParams(String str, Map<String, String> map) {
        ...
        if (!str.contains("?")) {
            return AbstractC0000a.m14k(str, "?", strCreateParamsString);
        }
        if (!str.endsWith("&")) {
            strCreateParamsString = "&".concat(strCreateParamsString);
        }
        return AbstractC0000a.m2C(str, strCreateParamsString);
    }
    ...
    public HttpResponse execute() throws Throwable {
        ...
        try {
            ...
            Logger.getLogger().m15167v("GET Request URL: " + strCreateUrlWithParams);
