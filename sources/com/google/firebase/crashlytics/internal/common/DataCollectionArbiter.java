...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z2) {
        Logger.getLogger().m15161d(AbstractC0000a.m15l("Crashlytics automatic data collection ", z2 ? "ENABLED" : "DISABLED", " by ", this.crashlyticsDataCollectionEnabled == null ? "global Firebase setting" : this.setInManifest ? "firebase_crashlytics_collection_enabled manifest flag" : "API", "."));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().m15164e("Could not read data collection permission from manifest", e);
            return null;
        }
    }
