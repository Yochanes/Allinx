...
public class IdManager implements InstallIdProvider {
    ...
    private synchronized String createAndCacheCrashlyticsInstallId(String str, SharedPreferences sharedPreferences) {
        ...
        Logger.getLogger().m15167v("Created new Crashlytics installation ID: " + id + " for FID: " + str);
    ...
    public FirebaseInstallationId fetchTrueFid(boolean z2) {
        ...
        if (z2) {
            try {
                ...
                Logger.getLogger().m15170w("Error getting Firebase authentication token.", e);
                token = null;
            }
        } else {
            token = null;
        ...
        try {
            ...
            Logger.getLogger().m15170w("Error getting Firebase installation id.", e2);
        }
    ...
    public synchronized InstallIdProvider.InstallIds getInstallIds() {
        ...
        Logger.getLogger().m15167v("Determining Crashlytics installation ID...");
        SharedPreferences sharedPrefs = CommonUtils.getSharedPrefs(this.appContext);
        String string = sharedPrefs.getString(PREFKEY_FIREBASE_IID, null);
        Logger.getLogger().m15167v("Cached Firebase Installation ID: " + string);
        if (this.dataCollectionArbiter.isAutomaticDataCollectionEnabled()) {
            FirebaseInstallationId firebaseInstallationIdFetchTrueFid = fetchTrueFid(false);
            Logger.getLogger().m15167v("Fetched Firebase Installation ID: " + firebaseInstallationIdFetchTrueFid.getFid());
        ...
        Logger.getLogger().m15167v("Install IDs: " + this.installIds);
        return this.installIds;
    }
    ...
    public String getModelName() {
        ...
        return AbstractC0000a.m14k(removeForwardSlashesIn(Build.MANUFACTURER), RemoteSettings.FORWARD_SLASH_STRING, removeForwardSlashesIn(Build.MODEL));
    }
