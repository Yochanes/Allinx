...
public class CommonUtils {
    ...
    public static final class Architecture {
        ...
        public static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().m15167v("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Logger.getLogger().m15164e(str, e);
            }
        }
    }
    ...
    public static List<BuildIdInfo> getBuildIdInfo(Context context) {
        ...
        if (resourcesIdentifier == 0 || resourcesIdentifier2 == 0 || resourcesIdentifier3 == 0) {
            Logger.getLogger().m15161d(String.format("Could not find resources: %d %d %d", Integer.valueOf(resourcesIdentifier), Integer.valueOf(resourcesIdentifier2), Integer.valueOf(resourcesIdentifier3)));
            return arrayList;
        }
        ...
        if (stringArray.length != stringArray3.length || stringArray2.length != stringArray3.length) {
            Logger.getLogger().m15161d(String.format("Lengths did not match: %d %d %d", Integer.valueOf(stringArray.length), Integer.valueOf(stringArray2.length), Integer.valueOf(stringArray3.length)));
            return arrayList;
        }
    ...
    public static String hexify(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            cArr[i3] = cArr2[i2 >>> 4];
            cArr[i3 + 1] = cArr2[b2 & Ascii.f42543SI];
        }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger.getLogger().m15164e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
}
