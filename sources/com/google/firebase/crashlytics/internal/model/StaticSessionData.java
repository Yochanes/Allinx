...
public abstract class StaticSessionData {
    ...
    public static abstract class DeviceData {
        public static DeviceData create(int i, String str, int i2, long j, long j2, boolean z2, int i3, String str2, String str3) {
            return new AutoValue_StaticSessionData_DeviceData(i, str, i2, j, j2, z2, i3, str2, str3);
        }
