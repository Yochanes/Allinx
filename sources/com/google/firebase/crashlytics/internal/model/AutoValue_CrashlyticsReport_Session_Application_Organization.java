...
final class AutoValue_CrashlyticsReport_Session_Application_Organization extends CrashlyticsReport.Session.Application.Organization {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Application.Organization.Builder {
        ...
        public /* synthetic */ Builder(CrashlyticsReport.Session.Application.Organization organization, C46801 c46801) {
            this(organization);
        }
        ...
        public CrashlyticsReport.Session.Application.Organization build() {
            ...
            if (str != null) {
                return new AutoValue_CrashlyticsReport_Session_Application_Organization(str, null);
            }
    ...
    public /* synthetic */ AutoValue_CrashlyticsReport_Session_Application_Organization(String str, C46801 c46801) {
        this(str);
    }
    ...
    public String toString() {
        return AbstractC0000a.m19p(new StringBuilder("Organization{clsId="), this.clsId, "}");
    }
