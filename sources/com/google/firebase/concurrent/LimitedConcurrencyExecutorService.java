...
final class LimitedConcurrencyExecutorService extends LimitedConcurrencyExecutor implements ExecutorService {
    ...
    public static /* synthetic */ Object m15145b(Runnable runnable, Object obj) {
        return lambda$submit$0(runnable, obj);
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ Object m15146c(Runnable runnable) {
    ...
    public <T> Future<T> submit(Runnable runnable, T t) {
        return submit(new CallableC4626j(runnable, t, 0));
    }

    @Override // java.util.concurrent.ExecutorService
    public Future<?> submit(Runnable runnable) {
        return submit(new CallableC4625i(runnable, 0));
    }
}
