...
public final /* data */ class SessionEvent {
    ...
    public SessionEvent(@NotNull EventType eventType, @NotNull SessionInfo sessionData, @NotNull ApplicationInfo applicationInfo) {
        Intrinsics.m18599g(eventType, "eventType");
        Intrinsics.m18599g(sessionData, "sessionData");
        Intrinsics.m18599g(applicationInfo, "applicationInfo");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.eventType == sessionEvent.eventType && Intrinsics.m18594b(this.sessionData, sessionEvent.sessionData) && Intrinsics.m18594b(this.applicationInfo, sessionEvent.applicationInfo);
    }
