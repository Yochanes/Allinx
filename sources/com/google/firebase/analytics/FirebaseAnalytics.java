...
public final class FirebaseAnalytics {
    ...
    private FirebaseAnalytics(zzdv zzdvVar) {
    ...
    public static FirebaseAnalytics getInstance(@NonNull Context context) {
        if (zza == null) {
            synchronized (FirebaseAnalytics.class) {
                try {
                    if (zza == null) {
                        zza = new FirebaseAnalytics(zzdv.zza(context));
                    }
                } finally {
                }
            }
    ...
    @Nullable
    @Keep
    public static zzky getScionFrontendApiImplementation(Context context, @Nullable Bundle bundle) {
        zzdv zzdvVarZza = zzdv.zza(context, (String) null, (String) null, (String) null, bundle);
        if (zzdvVarZza == null) {
            return null;
        }
        return new zzc(zzdvVarZza);
    }

    public static /* bridge */ /* synthetic */ zzdv zza(FirebaseAnalytics firebaseAnalytics) {
