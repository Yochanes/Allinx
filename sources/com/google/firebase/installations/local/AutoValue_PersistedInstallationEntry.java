...
final class AutoValue_PersistedInstallationEntry extends PersistedInstallationEntry {
    ...
    public static final class Builder extends PersistedInstallationEntry.Builder {
        ...
        public /* synthetic */ Builder(PersistedInstallationEntry persistedInstallationEntry, C47241 c47241) {
            this(persistedInstallationEntry);
        }

        @Override // com.google.firebase.installations.local.PersistedInstallationEntry.Builder
        public PersistedInstallationEntry build() {
            String strM2C = this.registrationStatus == null ? " registrationStatus" : "";
            if (this.expiresInSecs == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " expiresInSecs");
            }
            if (this.tokenCreationEpochInSecs == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " tokenCreationEpochInSecs");
            }
            if (strM2C.isEmpty()) {
    ...
    public /* synthetic */ AutoValue_PersistedInstallationEntry(String str, PersistedInstallation.RegistrationStatus registrationStatus, String str2, String str3, long j, long j2, String str4, C47241 c47241) {
    ...
    public String toString() {
        ...
        sb.append(", fisError=");
        return AbstractC0000a.m19p(sb, this.fisError, "}");
    }
