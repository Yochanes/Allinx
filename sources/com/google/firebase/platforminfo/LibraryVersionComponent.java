...
public class LibraryVersionComponent {
    ...
    public static /* synthetic */ LibraryVersion m15259a(String str, VersionExtractor versionExtractor, ComponentContainer componentContainer) {
    ...
    public static Component<?> fromContext(String str, VersionExtractor<Context> versionExtractor) {
        return Component.intoSetBuilder(LibraryVersion.class).add(Dependency.required((Class<?>) Context.class)).factory(new C4756a(0, str, versionExtractor)).build();
    }
