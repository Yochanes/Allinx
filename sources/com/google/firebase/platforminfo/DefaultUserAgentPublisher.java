...
import com.google.firebase.concurrent.C4624h;
...
public class DefaultUserAgentPublisher implements UserAgentPublisher {
    ...
    public static /* synthetic */ UserAgentPublisher m15258a(ComponentContainer componentContainer) {
        return lambda$component$0(componentContainer);
    }

    public static Component<UserAgentPublisher> component() {
        return Component.builder(UserAgentPublisher.class).add(Dependency.setOf((Class<?>) LibraryVersion.class)).factory(new C4624h(5)).build();
    }
