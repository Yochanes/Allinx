...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str) {
            ...
            this.bundle = bundle;
            this.data = new ArrayMap(0);
            if (TextUtils.isEmpty(str)) {
                throw new IllegalArgumentException(AbstractC0000a.m13j("Invalid to: ", str));
            }
            bundle.putString(Constants.MessagePayloadKeys.f42827TO, str);
        }
    ...
    public static class Notification {
        ...
        public /* synthetic */ Notification(NotificationParams notificationParams, C47371 c47371) {
    ...
    public RemoteMessage(@SafeParcelable.Param(m14480id = 2) Bundle bundle) {
        this.bundle = bundle;
    }
    ...
    @Nullable
    public String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f42827TO);
    }
