...
public class NotificationParams {
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            Log.w(TAG, userFriendlyKey(AbstractC0000a.m2C(str2, Constants.MessageNotificationKeys.TEXT_RESOURCE_SUFFIX)) + " resource not found: " + str2 + " Default value will be used.");
            return null;
        }
