...
public class ParcelableSparseBooleanArray extends SparseBooleanArray implements Parcelable {
    public static final Parcelable.Creator<ParcelableSparseBooleanArray> CREATOR = new C38821();

    /* JADX INFO: renamed from: com.google.android.material.internal.ParcelableSparseBooleanArray$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C38821 implements Parcelable.Creator<ParcelableSparseBooleanArray> {
        ...
        @Override // android.os.Parcelable.Creator
        @NonNull
        public /* bridge */ /* synthetic */ ParcelableSparseBooleanArray[] newArray(int i) {
            return newArray(i);
        }
