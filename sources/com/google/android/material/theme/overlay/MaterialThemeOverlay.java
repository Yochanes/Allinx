...
public class MaterialThemeOverlay {
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {R.attr.theme, C3734R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C3734R.attr.materialThemeOverlay};
    ...
    public static Context wrap(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        boolean z2 = (context instanceof ContextThemeWrapper) && ((ContextThemeWrapper) context).f661a == iObtainMaterialThemeOverlayId;
