...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C39601 implements ShapeAppearancePathProvider.PathListener {
        public C39601() {
        }
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C39612 implements ShapeAppearanceModel.CornerSizeUnaryOperator {
        final /* synthetic */ float val$strokeInsetLength;

        public C39612(float f) {
    ...
    public static /* synthetic */ boolean access$302(MaterialShapeDrawable materialShapeDrawable, boolean z2) {
    ...
    private void calculateStrokePath() {
        ShapeAppearanceModel shapeAppearanceModelWithTransformedCornerSizes = getShapeAppearanceModel().withTransformedCornerSizes(new C39612(-getStrokeInsetLength()));
    ...
    public int getShadowOffsetX() {
        return (int) (Math.sin(Math.toRadians(r0.shadowCompatRotation)) * ((double) this.drawableState.shadowCompatOffset));
    }

    public int getShadowOffsetY() {
        return (int) (Math.cos(Math.toRadians(r0.shadowCompatRotation)) * ((double) this.drawableState.shadowCompatOffset));
    }
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(@NonNull Context context, float f, @Nullable ColorStateList colorStateList) {
        if (colorStateList == null) {
            colorStateList = ColorStateList.valueOf(MaterialColors.getColor(context, C3734R.attr.colorSurface, "MaterialShapeDrawable"));
        }
    ...
    public MaterialShapeDrawable(@NonNull MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathShadowListener = new C39601();
    }
