...
public final class ScaleProvider implements VisibilityAnimatorProvider {
    ...
    /* JADX INFO: renamed from: com.google.android.material.transition.platform.ScaleProvider$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C40911 extends AnimatorListenerAdapter {
        final /* synthetic */ float val$originalScaleX;
        final /* synthetic */ float val$originalScaleY;
        final /* synthetic */ View val$view;

        public C40911(View view, float f, float f2) {
            this.val$view = view;
    ...
    private static Animator createScaleAnimator(View view, float f, float f2) {
        ...
        objectAnimatorOfPropertyValuesHolder.addListener(new C40911(view, scaleX, scaleY));
