...
class TransitionUtils {
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C40721 implements CornerSizeBinaryOperator {
        ...
        public C40721(RectF rectF, RectF rectF2, float f, float f2, float f3) {
    ...
    public static /* synthetic */ CornerSize m14752a(RectF rectF, CornerSize cornerSize) {
    ...
    public static ShapeAppearanceModel convertToRelativeCornerSizes(ShapeAppearanceModel shapeAppearanceModel, RectF rectF) {
        return shapeAppearanceModel.withTransformedCornerSizes(new C4073a(rectF));
    }
    ...
    public static void maybeAddTransition(TransitionSet transitionSet, @Nullable Transition transition) {
        if (transition != null) {
            transitionSet.m11996f(transition);
        }
    }
    ...
    public static void maybeRemoveTransition(TransitionSet transitionSet, @Nullable Transition transition) {
        if (transition != null) {
            transitionSet.m11998i(transition);
        }
    }
    ...
    public static ShapeAppearanceModel lerp(ShapeAppearanceModel shapeAppearanceModel, ShapeAppearanceModel shapeAppearanceModel2, RectF rectF, RectF rectF2, @FloatRange float f, @FloatRange float f2, @FloatRange float f3) {
        return f3 < f ? shapeAppearanceModel : f3 > f2 ? shapeAppearanceModel2 : transformCornerSizes(shapeAppearanceModel, shapeAppearanceModel2, rectF, new C40721(rectF, rectF2, f, f2, f3));
    }
}
