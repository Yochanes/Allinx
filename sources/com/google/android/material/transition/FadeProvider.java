...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C40591 implements ValueAnimator.AnimatorUpdateListener {
        ...
        public C40591(View view, float f, float f2, float f3, float f4) {
            this.val$view = view;
    ...
    /* JADX INFO: renamed from: com.google.android.material.transition.FadeProvider$2 */
    /* JADX INFO: compiled from: Proguard */
    public class C40602 extends AnimatorListenerAdapter {
        final /* synthetic */ float val$originalAlpha;
        final /* synthetic */ View val$view;

        public C40602(View view, float f) {
            this.val$view = view;
    ...
    private static Animator createFadeAnimator(View view, float f, float f2, @FloatRange float f3, @FloatRange float f4, float f5) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new C40591(view, f, f2, f3, f4));
        valueAnimatorOfFloat.addListener(new C40602(view, f5));
