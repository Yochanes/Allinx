...
public final class MaterialFadeThrough extends MaterialVisibility<FadeThroughProvider> {
    ...
    @AttrRes
    private static final int DEFAULT_THEMED_DURATION_ATTR = C3734R.attr.motionDurationLong1;

    @AttrRes
    private static final int DEFAULT_THEMED_EASING_ATTR = C3734R.attr.motionEasingEmphasizedInterpolator;
