...
public class MotionSpec {
    ...
    private final SimpleArrayMap<String, MotionTiming> timings = new SimpleArrayMap<>(0);
    private final SimpleArrayMap<String, PropertyValuesHolder[]> propertyValues = new SimpleArrayMap<>(0);
    ...
    public long getTotalDuration() {
        int i = this.timings.f3884c;
        long jMax = 0;
        for (int i2 = 0; i2 < i; i2++) {
            MotionTiming motionTiming = (MotionTiming) this.timings.m2131m(i2);
