...
class ClockHandView extends View {
    ...
    /* JADX INFO: renamed from: com.google.android.material.timepicker.ClockHandView$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C40291 extends AnimatorListenerAdapter {
        public C40291() {
        }
    ...
    public interface OnActionUpListener {
        void onActionUp(@FloatRange float f, boolean z2);
    }

    /* JADX INFO: compiled from: Proguard */
    public interface OnRotateListener {
        void onRotate(@FloatRange float f, boolean z2);
    }
    ...
    public static /* synthetic */ void m14748a(ClockHandView clockHandView, ValueAnimator valueAnimator) {
    ...
    private boolean handleTouchInput(float f, float f2, boolean z2, boolean z3, boolean z4) {
    ...
    private void setHandRotationInternal(@FloatRange float f, boolean z2) {
        float f2 = f % 360.0f;
        this.originalDeg = f2;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean zHandleTouchInput = this.changedDuringTouch | handleTouchInput(x, y2, z3, z2, z4);
    ...
    public void setHandRotation(@FloatRange float f) {
    ...
    public ClockHandView(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C3734R.attr.materialClockStyle);
    }

    public void setHandRotation(@FloatRange float f, boolean z2) {
        ...
        this.rotationAnimator.addUpdateListener(new C4044a(this));
        this.rotationAnimator.addListener(new C40291());
    ...
    public ClockHandView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.currentLevel = 1;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C3734R.styleable.ClockHandView, i, C3734R.style.Widget_MaterialComponents_TimePicker_Clock);
        this.animationDuration = MotionUtils.resolveThemeDuration(context, C3734R.attr.motionDurationLong2, DEFAULT_ANIMATION_DURATION);
        this.animationInterpolator = MotionUtils.resolveThemeInterpolator(context, C3734R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        this.circleRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C3734R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C3734R.styleable.ClockHandView_selectorSize, 0);
        this.selectorStrokeWidth = getResources().getDimensionPixelSize(C3734R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = r7.getDimensionPixelSize(C3734R.dimen.material_clock_hand_center_dot_radius);
        int color = typedArrayObtainStyledAttributes.getColor(C3734R.styleable.ClockHandView_clockHandColor, 0);
