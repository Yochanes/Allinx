...
public class ShadowDrawableWrapper extends DrawableWrapperCompat {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = context.getColor(C3734R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = context.getColor(C3734R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = context.getColor(C3734R.color.design_fab_shadow_end_color);
    ...
    private void buildShadowCorners() {
        ...
        if (f3 > 0.0f) {
            ...
            this.cornerShadowPaint.setShader(new RadialGradient(0.0f, 0.0f, f3, new int[]{0, this.shadowStartColor, this.shadowMiddleColor, this.shadowEndColor}, new float[]{0.0f, f4, AbstractC0000a.m1B(1.0f, f4, 2.0f, f4), 1.0f}, Shader.TileMode.CLAMP));
        }
    ...
    private void drawShadow(@NonNull Canvas canvas) {
        ...
        float f4 = f2 * 2.0f;
        boolean z2 = this.contentBounds.width() - f4 > 0.0f;
        boolean z3 = this.contentBounds.height() - f4 > 0.0f;
