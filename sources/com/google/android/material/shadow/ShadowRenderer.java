...
public class ShadowRenderer {
    ...
    public void drawCornerShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i, float f, float f2) {
        ...
        float fM1B = AbstractC0000a.m1B(1.0f, f5, 2.0f, f5);
    ...
    public void setShadowColor(int i) {
        this.shadowStartColor = ColorUtils.m7560i(i, COLOR_ALPHA_START);
        this.shadowMiddleColor = ColorUtils.m7560i(i, 20);
        this.shadowEndColor = ColorUtils.m7560i(i, 0);
