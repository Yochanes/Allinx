...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(String str, DateFormat dateFormat, @NonNull TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C3734R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new RunnableC3850a(this, str);
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m14679a(DateFormatTextWatcher dateFormatTextWatcher, long j) {
        dateFormatTextWatcher.lambda$createRangeErrorCallback$1(j);
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m14680b(DateFormatTextWatcher dateFormatTextWatcher, String str) {
        dateFormatTextWatcher.lambda$new$0(str);
    }

    private Runnable createRangeErrorCallback(long j) {
        return new RunnableC3851b(this, j);
    }
    ...
    private /* synthetic */ void lambda$new$0(String str) {
        ...
        textInputLayout.setError(context.getString(C3734R.string.mtrl_picker_invalid_format) + "\n" + String.format(context.getString(C3734R.string.mtrl_picker_invalid_format_use), sanitizeDateString(str)) + "\n" + String.format(context.getString(C3734R.string.mtrl_picker_invalid_format_example), sanitizeDateString(dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())))));
        onInvalidDate();
    }
