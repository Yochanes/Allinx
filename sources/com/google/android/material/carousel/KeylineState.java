...
final class KeylineState {
    ...
    public static final class Builder {
        ...
        public Builder addAnchorKeyline(float f, @FloatRange float f2, float f3) {
            return addKeyline(f, f2, f3, false, true);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @FloatRange float f2, float f3, boolean z2) {
            return addKeyline(f, f2, f3, z2, false);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder addKeylineRange(float f, @FloatRange float f2, float f3, int i) {
        ...
        public KeylineState build() {
            ...
            return new KeylineState(this.itemSize, arrayList, this.firstFocalKeylineIndex, this.lastFocalKeylineIndex, null);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @FloatRange float f2, float f3) {
            return addKeyline(f, f2, f3, false);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder addKeylineRange(float f, @FloatRange float f2, float f3, int i, boolean z2) {
            if (i > 0 && f3 > 0.0f) {
                for (int i2 = 0; i2 < i; i2++) {
                    addKeyline((i2 * f3) + f, f2, f3, z2);
                }
            }
            return this;
        }
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @FloatRange float f2, float f3, boolean z2, boolean z3, float f4, float f5, float f6) {
            if (f3 <= 0.0f) {
                return this;
            }
            if (z3) {
            ...
            Keyline keyline = new Keyline(UNKNOWN_LOC, f, f2, f3, z3, f4, f5, f6);
            if (z2) {
                if (this.tmpFirstFocalKeyline == null) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @FloatRange float f2, float f3, boolean z2, boolean z3, float f4) {
            return addKeyline(f, f2, f3, z2, z3, f4, 0.0f, 0.0f);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @FloatRange float f2, float f3, boolean z2, boolean z3) {
            float fAbs;
            float f4 = f3 / 2.0f;
            float f5 = f - f4;
            float f6 = f4 + f;
            ...
            return addKeyline(f, f2, f3, z2, z3, fAbs);
        }
    }
    ...
    public static final class Keyline {
        ...
        public static Keyline lerp(Keyline keyline, Keyline keyline2, @FloatRange float f) {
        ...
        public Keyline(float f, float f2, float f3, float f4, boolean z2, float f5, float f6, float f7) {
            this.loc = f;
            this.locOffset = f2;
            this.mask = f3;
    ...
    public /* synthetic */ KeylineState(float f, List list, int i, int i2, C37881 c37881) {
        this(f, list, i, i2);
    }
    ...
    public Keyline getLastKeyline() {
        return (Keyline) AbstractC1610a.m8729g(1, this.keylines);
    }
