...
public final class DeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    private static final FloatPropertyCompat<DeterminateDrawable<?>> INDICATOR_LENGTH_IN_LEVEL = new C39201("indicatorLevel");
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C39201 extends FloatPropertyCompat<DeterminateDrawable<?>> {
        public C39201(String str) {
            super(str);
        }

        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public /* bridge */ /* synthetic */ float getValue(Object obj) {
            return getValue((DeterminateDrawable<?>) obj);
        }

        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public /* bridge */ /* synthetic */ void setValue(Object obj, float f) {
            setValue((DeterminateDrawable<?>) obj, f);
        }
    ...
    public DeterminateDrawable(@NonNull Context context, @NonNull BaseProgressIndicatorSpec baseProgressIndicatorSpec, @NonNull DrawingDelegate<S> drawingDelegate) {
        ...
        springForce.m8774a();
        springForce.m8775b(SPRING_FORCE_STIFFNESS);
        SpringAnimation springAnimation = new SpringAnimation(this, INDICATOR_LENGTH_IN_LEVEL);
        springAnimation.f24263t = Float.MAX_VALUE;
        springAnimation.f24264u = false;
    ...
    public void addSpringAnimationEndListener(@NonNull DynamicAnimation.OnAnimationEndListener onAnimationEndListener) {
        ArrayList arrayList = this.springAnimation.f24253k;
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            ...
            int iM7629a = baseProgressIndicatorSpec.indicatorTrackGapSize;
            if (iM7629a > 0) {
                if (!(this.drawingDelegate instanceof LinearDrawingDelegate)) {
                    iM7629a = (int) ((MathUtils.m7629a(getIndicatorFraction(), 0.0f, GAP_RAMP_DOWN_THRESHOLD) * iM7629a) / GAP_RAMP_DOWN_THRESHOLD);
                }
                this.drawingDelegate.fillTrack(canvas, this.paint, getIndicatorFraction(), 1.0f, this.baseSpec.trackColor, getAlpha(), iM7629a);
            } else {
    ...
    public boolean onLevelChange(int i) {
        if (this.skipAnimationOnLevelChange) {
            ...
            springAnimation.f24244b = getIndicatorFraction() * 10000.0f;
            springAnimation.f24245c = true;
            this.springAnimation.m8770e(i);
        }
        return true;
    }
    ...
    @Override // com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setAlpha(@IntRange int i) {
        super.setAlpha(i);
    }
    ...
    public boolean setVisibleInternal(boolean z2, boolean z3, boolean z4) {
        ...
        this.skipAnimationOnLevelChange = false;
        this.springForce.m8775b(SPRING_FORCE_STIFFNESS / systemAnimatorDurationScale);
        return visibleInternal;
    }
