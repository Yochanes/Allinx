...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    /* JADX INFO: renamed from: com.google.android.material.textfield.DropdownMenuEndIconDelegate$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C40081 extends AnimatorListenerAdapter {
        public C40081() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            DropdownMenuEndIconDelegate.access$000(DropdownMenuEndIconDelegate.this).start();
        }
    }

    public DropdownMenuEndIconDelegate(@NonNull EndCompoundLayout endCompoundLayout) {
        super(endCompoundLayout);
        this.onIconClickListener = new ViewOnClickListenerC4019a(this, 1);
        this.onEditTextFocusChangeListener = new ViewOnFocusChangeListenerC4020b(this, 1);
        this.touchExplorationStateChangeListener = new C4025g(this);
        this.dropdownPopupActivatedAt = Long.MAX_VALUE;
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C3734R.attr.motionDurationShort3, DEFAULT_ANIMATION_FADE_IN_DURATION);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C3734R.attr.motionDurationShort3, DEFAULT_ANIMATION_FADE_OUT_DURATION);
    ...
    public static /* synthetic */ void m14738a(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate) {
    ...
    public static /* synthetic */ void m14739b(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate, boolean z2) {
        dropdownMenuEndIconDelegate.lambda$new$2(z2);
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ void m14740c(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate, ValueAnimator valueAnimator) {
    ...
    public static /* synthetic */ void m14741d(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate, View view, boolean z2) {
        dropdownMenuEndIconDelegate.lambda$new$1(view, z2);
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ boolean m14742e(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate, View view, MotionEvent motionEvent) {
        return dropdownMenuEndIconDelegate.lambda$setUpDropdownShowHideBehavior$4(view, motionEvent);
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ void m14743f(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate) {
        dropdownMenuEndIconDelegate.lambda$setUpDropdownShowHideBehavior$5();
    }

    /* JADX INFO: renamed from: g */
    public static /* synthetic */ void m14744g(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate, View view) {
    ...
    private ValueAnimator getAlphaAnimator(int i, float... fArr) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new C4021c(this, 2));
    ...
    private void initAnimators() {
        ...
        alphaAnimator.addListener(new C40081());
    }
    ...
    private void lambda$new$2(boolean z2) {
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new ViewOnTouchListenerC4023e(this));
        if (IS_LOLLIPOP) {
            this.autoCompleteTextView.setOnDismissListener(new C4024f(this));
        }
    ...
    public void afterEditTextChanged(Editable editable) {
        ...
        this.autoCompleteTextView.post(new RunnableC4022d(this, 1));
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    public int getIconContentDescriptionResId() {
        return C3734R.string.exposed_dropdown_menu_content_description;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    public int getIconDrawableResId() {
        return IS_LOLLIPOP ? C3734R.drawable.mtrl_dropdown_arrow : C3734R.drawable.mtrl_ic_arrow_drop_down;
    }
    ...
    public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        if (!EditTextUtils.isEditable(this.autoCompleteTextView)) {
            accessibilityNodeInfoCompat.m8014k(Spinner.class.getName());
        }
        if (Build.VERSION.SDK_INT >= 26 ? AbstractC1329b.m6448B(accessibilityNodeInfoCompat.f23504a) : accessibilityNodeInfoCompat.m8008e(4)) {
            accessibilityNodeInfoCompat.m8020q(null);
        }
    }
