...
public class MaterialBottomContainerBackHelper extends MaterialBackAnimationHelper<View> {
    ...
    /* JADX INFO: renamed from: com.google.android.material.motion.MaterialBottomContainerBackHelper$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C38951 extends AnimatorListenerAdapter {
        public C38951() {
        }
    ...
    public MaterialBottomContainerBackHelper(@NonNull View view) {
        ...
        this.maxScaleXDistance = resources.getDimension(C3734R.dimen.m3_back_progress_bottom_container_max_scale_x_distance);
        this.maxScaleYDistance = resources.getDimension(C3734R.dimen.m3_back_progress_bottom_container_max_scale_y_distance);
    }
    ...
    public void finishBackProgressNotPersistent(@NonNull BackEventCompat backEventCompat, @Nullable Animator.AnimatorListener animatorListener) {
        ...
        objectAnimatorOfFloat.setDuration(AnimationUtils.lerp(this.hideDurationMax, this.hideDurationMin, backEventCompat.f60c));
        objectAnimatorOfFloat.addListener(new C38951());
    ...
    public void finishBackProgressPersistent(@NonNull BackEventCompat backEventCompat, @Nullable Animator.AnimatorListener animatorListener) {
        Animator animatorCreateResetScaleAnimator = createResetScaleAnimator();
        animatorCreateResetScaleAnimator.setDuration(AnimationUtils.lerp(this.hideDurationMax, this.hideDurationMin, backEventCompat.f60c));
        if (animatorListener != null) {
    ...
    public void updateBackProgress(@NonNull BackEventCompat backEventCompat) {
        ...
        updateBackProgress(backEventCompat.f60c);
    }
