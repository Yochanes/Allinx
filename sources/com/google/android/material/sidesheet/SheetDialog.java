...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    private static final int COORDINATOR_LAYOUT_ID = C3734R.id.coordinator;
    private static final int TOUCH_OUTSIDE_ID = C3734R.id.touch_outside;
    ...
    /* JADX INFO: renamed from: com.google.android.material.sidesheet.SheetDialog$1 */
    /* JADX INFO: compiled from: Proguard */
    public class C39661 extends AccessibilityDelegateCompat {
        public C39661() {
        }
    ...
    public static /* synthetic */ void m14714b(SheetDialog sheetDialog, View view) {
    ...
    private void maybeUpdateWindowAnimationsBasedOnLayoutDirection() {
        ...
        int i = ((CoordinatorLayout.LayoutParams) this.sheet.getLayoutParams()).f22914c;
        FrameLayout frameLayout2 = this.sheet;
        WeakHashMap weakHashMap = ViewCompat.f23405a;
        window.setWindowAnimations(Gravity.getAbsoluteGravity(i, frameLayout2.getLayoutDirection()) == 3 ? C3734R.style.Animation_Material3_SideSheetDialog_Left : C3734R.style.Animation_Material3_SideSheetDialog_Right);
    }
    ...
    private View wrapInSheet(int i, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ...
        coordinatorLayout.findViewById(TOUCH_OUTSIDE_ID).setOnClickListener(new ViewOnClickListenerC3971a(this));
        ViewCompat.m7765A(getSheet(), new C39661());
        return this.container;
    }
    ...
    public void setSheetEdge(@GravityInt int i) {
        ...
        if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
            ((CoordinatorLayout.LayoutParams) layoutParams).f22914c = i;
            maybeUpdateWindowAnimationsBasedOnLayoutDirection();
        }
    }
