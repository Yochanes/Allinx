...
public final class Score {
    ...
    public static class ScoredComparator implements Comparator<ScoredHCT> {
        ...
        public /* bridge */ /* synthetic */ int compare(ScoredHCT scoredHCT, ScoredHCT scoredHCT2) {
            return compare2(scoredHCT, scoredHCT2);
        }

        /* JADX INFO: renamed from: compare, reason: avoid collision after fix types in other method */
        public int compare2(ScoredHCT scoredHCT, ScoredHCT scoredHCT2) {
    ...
    public static List<Integer> score(Map<Integer, Integer> map, int i, int i2, boolean z2) {
