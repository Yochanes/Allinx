...
public class HctSolver {
    ...
    public static int findResultByJ(double d, double d2, double d3) {
        ...
        while (i < 5) {
            ...
            double d11 = dSqrt;
            double dPow3 = (Math.pow(d8, (d9 / viewingConditions.getC()) / viewingConditions.getZ()) * viewingConditions.getAw()) / viewingConditions.getNbb();
            double d12 = (((0.305d + dPow3) * 23.0d) * dPow2) / (((dPow2 * 108.0d) * dSin) + (((dPow2 * d7) * dCos) + (23.0d * ncb)));
            double d13 = d12 * dCos;
            double d14 = d12 * dSin;
            double d15 = dPow3 * 460.0d;
            double[] dArrMatrixMultiply = MathUtils.matrixMultiply(new double[]{inverseChromaticAdaptation(((288.0d * d14) + ((451.0d * d13) + d15)) / 1403.0d), inverseChromaticAdaptation(((d15 - (891.0d * d13)) - (261.0d * d14)) / 1403.0d), inverseChromaticAdaptation(((d15 - (d13 * 220.0d)) - (d14 * 6300.0d)) / 1403.0d)}, LINRGB_FROM_SCALED_DISCOUNT);
    ...
    public static double[] lerpPoint(double[] dArr, double d, double[] dArr2) {
        double d2 = dArr[0];
        double d3 = ((dArr2[0] - d2) * d) + d2;
        double d4 = dArr[1];
        double d5 = ((dArr2[1] - d4) * d) + d4;
        double d6 = dArr[2];
        return new double[]{d3, d5, ((dArr2[2] - d6) * d) + d6};
    }
