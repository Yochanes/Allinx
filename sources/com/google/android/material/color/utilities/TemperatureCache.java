...
public final class TemperatureCache {
    ...
    public static /* synthetic */ Double m14678a(TemperatureCache temperatureCache, Hct hct) {
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Collections.sort(arrayList, Comparator.comparing(new C3810a(this, 2), new C0281g(5)));
    ...
    public List<Hct> getAnalogousColors(int i, int i2) {
        ...
        while (true) {
            ...
            while (z2 && arrayList.size() < i2) {
                arrayList.add(hct2);
                int i6 = i4;
                z2 = dAbs >= ((double) (arrayList.size() + i5)) * d;
                i5++;
                i4 = i6;
            }
            i4++;
