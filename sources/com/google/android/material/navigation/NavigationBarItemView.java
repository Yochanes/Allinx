...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    /* JADX INFO: renamed from: com.google.android.material.navigation.NavigationBarItemView$1 */
    /* JADX INFO: compiled from: Proguard */
    public class ViewOnLayoutChangeListenerC39001 implements View.OnLayoutChangeListener {
        public ViewOnLayoutChangeListenerC39001() {
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.navigation.NavigationBarItemView$2 */
    /* JADX INFO: compiled from: Proguard */
    public class RunnableC39012 implements Runnable {
        final /* synthetic */ int val$width;

        public RunnableC39012(int i) {
            this.val$width = i;
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.navigation.NavigationBarItemView$3 */
    /* JADX INFO: compiled from: Proguard */
    public class C39023 implements ValueAnimator.AnimatorUpdateListener {
        final /* synthetic */ float val$newProgress;

        public C39023(float f) {
            this.val$newProgress = f;
        }

        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            NavigationBarItemView.access$500(NavigationBarItemView.this, ((Float) valueAnimator.getAnimatedValue()).floatValue(), this.val$newProgress);
        }
    }
    ...
    public static class ActiveIndicatorTransform {
        ...
        public float calculateAlpha(@FloatRange float f, @FloatRange float f2) {
            return AnimationUtils.lerp(0.0f, 1.0f, f2 == 0.0f ? 0.8f : 0.0f, f2 == 0.0f ? 1.0f : ALPHA_FRACTION, f);
        }

        public float calculateScaleX(@FloatRange float f, @FloatRange float f2) {
            return AnimationUtils.lerp(SCALE_X_HIDDEN, 1.0f, f);
        }

        public float calculateScaleY(@FloatRange float f, @FloatRange float f2) {
            return 1.0f;
        }

        public void updateForProgress(@FloatRange float f, @FloatRange float f2, @NonNull View view) {
            view.setScaleX(calculateScaleX(f, f2));
            view.setScaleY(calculateScaleY(f, f2));
            view.setAlpha(calculateAlpha(f, f2));
        }

        public /* synthetic */ ActiveIndicatorTransform(ViewOnLayoutChangeListenerC39001 viewOnLayoutChangeListenerC39001) {
            this();
        }
    }
    ...
    public static class ActiveIndicatorUnlabeledTransform extends ActiveIndicatorTransform {
        ...
        public /* synthetic */ ActiveIndicatorUnlabeledTransform(ViewOnLayoutChangeListenerC39001 viewOnLayoutChangeListenerC39001) {
            this();
        }
    }
    ...
    public NavigationBarItemView(@NonNull Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C3734R.id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C3734R.id.navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(C3734R.id.navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(C3734R.id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C3734R.id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C3734R.id.navigation_bar_item_large_label_view);
        this.largeLabel = textView2;
        setBackgroundResource(getItemBackgroundResId());
        this.itemPaddingTop = getResources().getDimensionPixelSize(getItemDefaultMarginResId());
        this.itemPaddingBottom = viewGroup.getPaddingBottom();
        this.activeIndicatorLabelPadding = getResources().getDimensionPixelSize(C3734R.dimen.m3_navigation_item_active_indicator_label_padding);
        ...
        if (imageView != null) {
            imageView.addOnLayoutChangeListener(new ViewOnLayoutChangeListenerC39001());
        }
    }
    ...
    public static /* synthetic */ void access$400(NavigationBarItemView navigationBarItemView, int i) {
        navigationBarItemView.updateActiveIndicatorLayoutParams(i);
    }

    public static /* synthetic */ void access$500(NavigationBarItemView navigationBarItemView, float f, float f2) {
    ...
    private void maybeAnimateActiveIndicatorToProgress(@FloatRange float f) {
        if (this.activeIndicatorEnabled && this.initialized) {
            ...
            if (isAttachedToWindow()) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new C39023(f));
                this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C3734R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
                this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C3734R.attr.motionDurationLong2, getResources().getInteger(C3734R.integer.material_motion_duration_long_1)));
    ...
    private void refreshItemBackground() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            AbstractC2433a.m12781x(this, z2);
        }
    }

    private void setActiveIndicatorProgress(@FloatRange float f, float f2) {
    ...
    public int getItemBackgroundResId() {
        return C3734R.drawable.mtrl_navigation_bar_item_background;
    }
    ...
    public int getItemDefaultMarginResId() {
        return C3734R.dimen.mtrl_navigation_bar_item_default_margin;
    }
    ...
    public void initialize(@NonNull MenuItemImpl menuItemImpl, int i) {
        ...
        setId(menuItemImpl.f843a);
        if (!TextUtils.isEmpty(menuItemImpl.f859q)) {
            setContentDescription(menuItemImpl.f859q);
        }
        TooltipCompat.m733a(this, !TextUtils.isEmpty(menuItemImpl.f860r) ? menuItemImpl.f860r : menuItemImpl.f847e);
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (badgeDrawable != null && badgeDrawable.isVisible()) {
            MenuItemImpl menuItemImpl = this.itemData;
            CharSequence charSequence = menuItemImpl.f847e;
            if (!TextUtils.isEmpty(menuItemImpl.f859q)) {
                charSequence = this.itemData.f859q;
            }
        ...
        accessibilityNodeInfoCompat.m8017n(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.m8034a(0, 1, getItemVisiblePosition(), 1, false, isSelected()));
        if (isSelected()) {
            accessibilityNodeInfoCompat.m8015l(false);
            accessibilityNodeInfoCompat.m8011h(AccessibilityNodeInfoCompat.AccessibilityActionCompat.f23509g);
        }
        accessibilityNodeInfo.getExtras().putCharSequence("AccessibilityNodeInfo.roleDescription", getResources().getString(C3734R.string.item_view_role_description));
    }

    @Override // android.view.View
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        super.onSizeChanged(i, i2, i3, i4);
        post(new RunnableC39012(i));
    }
    ...
    public void setEnabled(boolean z2) {
        ...
        if (z2) {
            ViewCompat.m7774J(this, new PointerIconCompat(PointerIcon.getSystemIcon(getContext(), MTCommonConstants.MainWhat.ON_SERVICE_DISCONNECTED)));
        } else {
            ViewCompat.m7774J(this, null);
        }
    }
    ...
    public void setTitle(@Nullable CharSequence charSequence) {
        ...
        MenuItemImpl menuItemImpl = this.itemData;
        if (menuItemImpl == null || TextUtils.isEmpty(menuItemImpl.f859q)) {
            setContentDescription(charSequence);
        }
        MenuItemImpl menuItemImpl2 = this.itemData;
        if (menuItemImpl2 != null && !TextUtils.isEmpty(menuItemImpl2.f860r)) {
            charSequence = this.itemData.f860r;
        }
        TooltipCompat.m733a(this, charSequence);
    }
