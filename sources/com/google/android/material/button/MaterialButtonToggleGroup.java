...
public class MaterialButtonToggleGroup extends LinearLayout {
    private static final int DEF_STYLE_RES = C3734R.style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C37801 implements Comparator<MaterialButton> {
        public C37801() {
        }

        @Override // java.util.Comparator
        public /* bridge */ /* synthetic */ int compare(MaterialButton materialButton, MaterialButton materialButton2) {
            return compare2(materialButton, materialButton2);
        }
    ...
    /* JADX INFO: compiled from: Proguard */
    public class C37812 extends AccessibilityDelegateCompat {
        public C37812() {
        }
        ...
        public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            accessibilityNodeInfoCompat.m8017n(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.m8034a(0, 1, MaterialButtonToggleGroup.access$100(MaterialButtonToggleGroup.this, view), 1, false, ((MaterialButton) view).isChecked()));
        }
    }
    ...
    public class PressedStateTracker implements MaterialButton.OnPressedChangeListener {
        ...
        public /* synthetic */ PressedStateTracker(MaterialButtonToggleGroup materialButtonToggleGroup, C37801 c37801) {
            this();
        }
    }
    ...
    private void checkInternal(@IdRes int i, boolean z2) {
        if (i == -1) {
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        ViewCompat.m7765A(materialButton, new C37812());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        new AccessibilityNodeInfoCompat(accessibilityNodeInfo).m8016m(AccessibilityNodeInfoCompat.CollectionInfoCompat.m8033a(1, getVisibleButtonCount(), isSingleSelection() ? 1 : 2, false));
    }
    ...
    public void setEnabled(boolean z2) {
        super.setEnabled(z2);
        for (int i = 0; i < getChildCount(); i++) {
            getChildButton(i).setEnabled(z2);
        }
    }
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C3734R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.childOrderComparator = new C37801();
        this.skipCheckedStateTracker = false;
        this.checkedIds = new HashSet();
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C3734R.styleable.MaterialButtonToggleGroup, i, i2, new int[0]);
        setSingleSelection(typedArrayObtainStyledAttributes.getBoolean(C3734R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.defaultCheckId = typedArrayObtainStyledAttributes.getResourceId(C3734R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.selectionRequired = typedArrayObtainStyledAttributes.getBoolean(C3734R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
        setChildrenDrawingOrderEnabled(true);
        setEnabled(typedArrayObtainStyledAttributes.getBoolean(C3734R.styleable.MaterialButtonToggleGroup_android_enabled, true));
