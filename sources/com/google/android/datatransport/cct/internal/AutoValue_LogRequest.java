...
final class AutoValue_LogRequest extends LogRequest {
    ...
    public static final class Builder extends LogRequest.Builder {
        ...
        public LogRequest build() {
            String strM2C = this.requestTimeMs == null ? " requestTimeMs" : "";
            if (this.requestUptimeMs == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " requestUptimeMs");
            }
            if (strM2C.isEmpty()) {
                return new AutoValue_LogRequest(this.requestTimeMs.longValue(), this.requestUptimeMs.longValue(), this.clientInfo, this.logSource, this.logSourceName, this.logEvents, this.qosTier, null);
            }
    ...
    public /* synthetic */ AutoValue_LogRequest(long j, long j2, ClientInfo clientInfo, Integer num, String str, List list, QosTier qosTier, C36981 c36981) {
