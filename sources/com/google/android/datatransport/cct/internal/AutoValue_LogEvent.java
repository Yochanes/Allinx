...
final class AutoValue_LogEvent extends LogEvent {
    ...
    public static final class Builder extends LogEvent.Builder {
        ...
        public LogEvent build() {
            String strM2C = this.eventTimeMs == null ? " eventTimeMs" : "";
            if (this.eventUptimeMs == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " eventUptimeMs");
            }
            if (this.timezoneOffsetSeconds == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " timezoneOffsetSeconds");
            }
            if (strM2C.isEmpty()) {
                return new AutoValue_LogEvent(this.eventTimeMs.longValue(), this.eventCode, this.complianceData, this.eventUptimeMs.longValue(), this.sourceExtension, this.sourceExtensionJsonProto3, this.timezoneOffsetSeconds.longValue(), this.networkConnectionInfo, this.experimentIds, null);
            }
    ...
    public /* synthetic */ AutoValue_LogEvent(long j, Integer num, ComplianceData complianceData, long j2, byte[] bArr, String str, long j3, NetworkConnectionInfo networkConnectionInfo, ExperimentIds experimentIds, C36971 c36971) {
