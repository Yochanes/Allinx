...
final class CctTransportBackend implements TransportBackend {
    ...
    public static /* synthetic */ HttpResponse m14409a(CctTransportBackend cctTransportBackend, HttpRequest httpRequest) {
        return cctTransportBackend.doSend(httpRequest);
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ HttpRequest m14410b(HttpRequest httpRequest, HttpResponse httpResponse) {
        return lambda$send$0(httpRequest, httpResponse);
    }

    private HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        Logging.m14418i(LOG_TAG, "Making request to: %s", httpRequest.url);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.m14418i(LOG_TAG, "Status Code: %d", Integer.valueOf(responseCode));
                    Logging.m14414d(LOG_TAG, "Content-Type: %s", httpURLConnection.getHeaderField("Content-Type"));
                    Logging.m14414d(LOG_TAG, "Content-Encoding: %s", httpURLConnection.getHeaderField("Content-Encoding"));
            ...
            e = e;
            Logging.m14417e(LOG_TAG, "Couldn't encode request, returning with 400", e);
            return new HttpResponse(CarouselScreenFragment.CAROUSEL_ANIMATION_MS, null, 0L);
        } catch (ConnectException e2) {
            e = e2;
            Logging.m14417e(LOG_TAG, "Couldn't open connection, returning with 500", e);
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m14417e(LOG_TAG, "Unable to find version code for package", e);
            return -1;
        }
    }
    ...
    private BatchedLogRequest getRequestBody(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m14408of("proto"))) {
                    builderProtoBuilder = LogEvent.protoBuilder(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m14408of(MTPushConstants.Analysis.KEY_JSON))) {
                    builderProtoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m14419w(LOG_TAG, "Received event of unsupported encoding %s. Skipping...", encoding);
                }
    ...
    private static /* synthetic */ HttpRequest lambda$send$0(HttpRequest httpRequest, HttpResponse httpResponse) {
        ...
        Logging.m14414d(LOG_TAG, "Following redirect to: %s", url);
    ...
    private static URL parseUrlOrThrow(String str) {
        try {
            ...
            throw new IllegalArgumentException(AbstractC0000a.m13j("Invalid url: ", str), e);
        }
    }
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(urlOrThrow, requestBody, aPIKey), new C3689a(this), new C3690b());
            int i = httpResponse.code;
            if (i == 200) {
                return BackendResponse.m14412ok(httpResponse.nextRequestMillis);
            }
            if (i < 500 && i != 404) {
            ...
            Logging.m14417e(LOG_TAG, "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
