...
public final class CCTDestination implements EncodedDestination {
    ...
    static {
        ...
        SUPPORTED_ENCODINGS = Collections.unmodifiableSet(new HashSet(Arrays.asList(Encoding.m14408of("proto"), Encoding.m14408of(MTPushConstants.Analysis.KEY_JSON))));
    ...
    public byte[] asByteArray() {
        ...
        return (EXTRAS_VERSION_MARKER + str2 + EXTRAS_DELIMITER + str).getBytes(Charset.forName("UTF-8"));
    }
