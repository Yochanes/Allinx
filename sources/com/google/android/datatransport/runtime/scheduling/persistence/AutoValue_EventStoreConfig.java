...
final class AutoValue_EventStoreConfig extends EventStoreConfig {
    ...
    public static final class Builder extends EventStoreConfig.Builder {
        ...
        public EventStoreConfig build() {
            String strM2C = this.maxStorageSizeInBytes == null ? " maxStorageSizeInBytes" : "";
            if (this.loadBatchSize == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " loadBatchSize");
            }
            if (this.criticalSectionEnterTimeoutMs == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " criticalSectionEnterTimeoutMs");
            }
            if (this.eventCleanUpAge == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " eventCleanUpAge");
            }
            if (this.maxBlobByteSizePerRow == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " maxBlobByteSizePerRow");
            }
            if (strM2C.isEmpty()) {
    ...
    public /* synthetic */ AutoValue_EventStoreConfig(long j, int i, int i2, long j2, int i3, C37131 c37131) {
        this(j, i, i2, j2, i3);
    }
    ...
    public String toString() {
        ...
        return AbstractC0000a.m11h(this.maxBlobByteSizePerRow, "}", sb);
    }
