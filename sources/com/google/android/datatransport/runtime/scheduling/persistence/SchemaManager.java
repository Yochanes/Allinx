...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        C3723i c3723i = new C3723i(0);
        MIGRATE_TO_V1 = c3723i;
        C3723i c3723i2 = new C3723i(1);
        MIGRATE_TO_V2 = c3723i2;
        C3723i c3723i3 = new C3723i(2);
        MIGRATE_TO_V3 = c3723i3;
        C3723i c3723i4 = new C3723i(3);
        MIGRATE_TO_V4 = c3723i4;
        C3723i c3723i5 = new C3723i(4);
        MIGRATION_TO_V5 = c3723i5;
        C3723i c3723i6 = new C3723i(5);
        MIGRATE_TO_V6 = c3723i6;
        C3723i c3723i7 = new C3723i(6);
        MIGRATE_TO_V7 = c3723i7;
        INCREMENTAL_MIGRATIONS = Arrays.asList(c3723i, c3723i2, c3723i3, c3723i4, c3723i5, c3723i6, c3723i7);
    }
    ...
    public static /* synthetic */ void m14461a(SQLiteDatabase sQLiteDatabase) {
        lambda$static$0(sQLiteDatabase);
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m14462b(SQLiteDatabase sQLiteDatabase) {
        lambda$static$6(sQLiteDatabase);
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ void m14463d(SQLiteDatabase sQLiteDatabase) {
        lambda$static$2(sQLiteDatabase);
    }
    ...
    public static /* synthetic */ void m14464g(SQLiteDatabase sQLiteDatabase) {
        lambda$static$4(sQLiteDatabase);
    }

    /* JADX INFO: renamed from: h */
    public static /* synthetic */ void m14465h(SQLiteDatabase sQLiteDatabase) {
        lambda$static$5(sQLiteDatabase);
    }

    /* JADX INFO: renamed from: i */
    public static /* synthetic */ void m14466i(SQLiteDatabase sQLiteDatabase) {
        lambda$static$1(sQLiteDatabase);
    }

    /* JADX INFO: renamed from: j */
    public static /* synthetic */ void m14467j(SQLiteDatabase sQLiteDatabase) {
        lambda$static$3(sQLiteDatabase);
    }
    ...
    private static /* synthetic */ void lambda$static$5(SQLiteDatabase sQLiteDatabase) {
    ...
    private void upgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i2 <= list.size()) {
            ...
            StringBuilder sbM24u = AbstractC0000a.m24u("Migration from ", " to ", " was requested, but cannot be performed. Only ", i, i2);
            sbM24u.append(list.size());
            sbM24u.append(" migrations are provided");
