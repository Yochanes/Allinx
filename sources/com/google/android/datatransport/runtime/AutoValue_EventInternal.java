...
final class AutoValue_EventInternal extends EventInternal {
    ...
    public static final class Builder extends EventInternal.Builder {
        ...
        public EventInternal build() {
            String strM2C = this.transportName == null ? " transportName" : "";
            if (this.encodedPayload == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " encodedPayload");
            }
            if (this.eventMillis == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " eventMillis");
            }
            if (this.uptimeMillis == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " uptimeMillis");
            }
            if (this.autoMetadata == null) {
                strM2C = AbstractC0000a.m2C(strM2C, " autoMetadata");
            }
            if (strM2C.isEmpty()) {
    ...
    public /* synthetic */ AutoValue_EventInternal(String str, Integer num, EncodedPayload encodedPayload, long j, long j2, Map map, Integer num2, String str2, byte[] bArr, byte[] bArr2, C37001 c37001) {
