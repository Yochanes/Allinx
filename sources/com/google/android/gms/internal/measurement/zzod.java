...
final class zzod extends zzoe {
    ...
    @Override // com.google.android.gms.internal.measurement.zzoe
    public final String zza(byte[] bArr, int i, int i2) throws zzlk {
            ...
            while (i < i3) {
                ...
                if (b3 >= 0) {
                    ...
                    if (i6 < i3 - 1) {
                        int i9 = i + 2;
                        i += 3;
                        zzob.zza(b3, bArr[i6], bArr[i9], cArr, i5);
                        i5++;
                    } else {
                        throw zzlk.zzd();
                    }
                    ...
                    byte b6 = bArr[i + 2];
                    i += 4;
                    zzob.zza(b3, b5, b6, bArr[i10], cArr, i5);
                    i5 += 2;
                } else {
                    throw zzlk.zzd();
                }
