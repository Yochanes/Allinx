...
final class zzce extends zzcm {
    ...
    public /* synthetic */ zzce(String str, boolean z2, boolean z3, zzcc zzccVar, zzcb zzcbVar, zzco zzcoVar, zzcg zzcgVar) {
        this(str, false, z3, null, null, zzcoVar);
    }
    ...
    public final int hashCode() {
        int iHashCode = (((((this.zzc.hashCode() ^ 1000003) * 1000003) ^ (this.zzd ? 1231 : 1237)) * 1000003) ^ (this.zze ? 1231 : 1237)) * 1000003;
    ...
    public final String toString() {
        return "FileComplianceOptions{fileOwner=" + this.zzc + ", hasDifferentDmaOwner=" + this.zzd + ", skipChecks=" + this.zze + ", dataForwardingNotAllowedResolver=" + String.valueOf(this.zzf) + ", multipleProductIdGroupsResolver=" + String.valueOf(this.zzg) + ", filePurpose=" + String.valueOf(this.zzh) + "}";
    }
