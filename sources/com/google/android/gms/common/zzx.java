...
class zzx {
    ...
    private zzx(boolean z2, int i, int i2, @Nullable String str, @Nullable Throwable th) {
        this.zza = z2;
        this.zzd = i;
        this.zzb = str;
        this.zzc = th;
    ...
    public /* synthetic */ zzx(boolean z2, int i, int i2, String str, Throwable th, zzw zzwVar) {
