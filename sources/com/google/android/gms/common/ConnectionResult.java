...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m14479id = 2)
    private final int zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getResolution", m14479id = 3)
    private final PendingIntent zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getErrorMessage", m14479id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m14480id = 1) int i, @SafeParcelable.Param(m14480id = 2) int i2, @Nullable @SafeParcelable.Param(m14480id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m14480id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        return AbstractC0000a.m10g(i, "UNKNOWN_ERROR_CODE(", ")");
                }
        }
    }
