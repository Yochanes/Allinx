...
final class zzn {
    ...
    public static /* synthetic */ String zzd(boolean z2, String str, zzj zzjVar) {
        ...
        return str2 + ": pkg=" + str + ", sha256=" + Hex.bytesToStringLowercase(messageDigestZza.digest(zzjVar.zzf())) + ", atk=" + z2 + ", ver=12451000.false";
    }
    ...
    private static zzx zzh(String str, zzj zzjVar, boolean z2, boolean z3) {
        try {
            zzj();
            Preconditions.checkNotNull(zzg);
            try {
                return zze.zzh(new zzs(str, zzjVar, z2, z3), ObjectWrapper.wrap(zzg.getPackageManager())) ? zzx.zzb() : new zzv(new zze(z2, str, zzjVar), null);
