...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", m14479id = 1)
    private final int zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", m14479id = 2)
    private final String zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", m14479id = 3)
    private final PendingIntent zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getConnectionResult", m14479id = 4)
    ...
    public Status(@SafeParcelable.Param(m14480id = 1) int i, @Nullable @SafeParcelable.Param(m14480id = 2) String str, @Nullable @SafeParcelable.Param(m14480id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m14480id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = str;
    ...
    public void startResolutionForResult(@NonNull ActivityResultLauncher<IntentSenderRequest> activityResultLauncher) {
        if (hasResolution()) {
            ...
            activityResultLauncher.mo180a(new IntentSenderRequest(intentSender, builder.f234a, builder.f235b, builder.f236c));
        }
    }
