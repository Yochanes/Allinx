...
public final class zaad {
    ...
    public final void zac(BasePendingResult<? extends Result> basePendingResult, boolean z2) {
        this.zaa.put(basePendingResult, Boolean.valueOf(z2));
        basePendingResult.addStatusListener(new zaab(this, basePendingResult));
    }

    public final <TResult> void zad(TaskCompletionSource<TResult> taskCompletionSource, boolean z2) {
