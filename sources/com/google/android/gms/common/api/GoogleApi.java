...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public ClientSettings.Builder createClientSettingsBuilder() {
        ...
        builder.zab(account);
        O o3 = this.zae;
        Set<Scope> requestedScopes = (!(o3 instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) || (googleSignInAccount = ((Api.ApiOptions.HasGoogleSignInAccountOptions) o3).getGoogleSignInAccount()) == null) ? Collections.EMPTY_SET : googleSignInAccount.getRequestedScopes();
