...
public final class Preconditions {
    ...
    public static void checkHandlerThread(@NonNull Handler handler) {
        ...
        if (looperMyLooper != handler.getLooper()) {
            throw new IllegalStateException(AbstractC0000a.m15l("Must be called on ", handler.getLooper().getThread().getName(), " thread, but got ", looperMyLooper != null ? looperMyLooper.getThread().getName() : "null current looper", "."));
        }
    }
