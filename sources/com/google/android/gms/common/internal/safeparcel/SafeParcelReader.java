...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(AbstractC0000a.m9f(i, "Overread allowed size end="), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(AbstractC0455a.m2237l(iDataPosition, i, "Size read is invalid start=", " end="), parcel);
        }
        return i;
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        throw new ParseException(AbstractC0000a.m19p(AbstractC0000a.m24u("Expected size ", " got ", " (0x", i3, i2), Integer.toHexString(i2), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(AbstractC0000a.m19p(AbstractC0000a.m24u("Expected size ", " got ", " (0x", i2, size), Integer.toHexString(size), ")"), parcel);
    }
}
