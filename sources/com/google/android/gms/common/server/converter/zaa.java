...
public final class zaa extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", m14479id = 2)
    private final StringToIntConverter zab;

    @SafeParcelable.Constructor
    public zaa(@SafeParcelable.Param(m14480id = 1) int i, @SafeParcelable.Param(m14480id = 2) StringToIntConverter stringToIntConverter) {
        this.zaa = i;
