...
public abstract class FastJsonResponse {
    ...
    private final <I, O> void zaE(Field<I, O> field, @Nullable I i) {
        ...
        switch (i2) {
            ...
            case 3:
            default:
                throw new IllegalStateException(AbstractC2929c.m13702g(44, i2, "Unsupported type for conversion: "));
            case 4:
                if (oZae != null) {
    ...
    public final <O> void zai(@NonNull Field<Boolean, O> field, boolean z2) {
        if (Field.zac(field) != null) {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "getTypeIn", m14479id = 2)
        protected final int zaa;

        @SafeParcelable.Field(getter = "isTypeInArray", m14479id = 3)
        protected final boolean zab;

        @SafeParcelable.Field(getter = "getTypeOut", m14479id = 4)
        protected final int zac;

        @SafeParcelable.Field(getter = "isTypeOutArray", m14479id = 5)
        protected final boolean zad;

        @NonNull
        @SafeParcelable.Field(getter = "getOutputFieldName", m14479id = 6)
        protected final String zae;

        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", m14479id = 7)
        ...
        @Nullable
        @SafeParcelable.Field(getter = "getConcreteTypeName", m14479id = 8)
        protected final String zah;

        @SafeParcelable.VersionField(getter = "getVersionCode", m14482id = 1)
        private final int zai;
        private zan zaj;

        @Nullable
        @SafeParcelable.Field(getter = "getWrappedConverter", m14479id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        private FieldConverter<I, O> zak;

        @SafeParcelable.Constructor
        public Field(@SafeParcelable.Param(m14480id = 1) int i, @SafeParcelable.Param(m14480id = 2) int i2, @SafeParcelable.Param(m14480id = 3) boolean z2, @SafeParcelable.Param(m14480id = 4) int i3, @SafeParcelable.Param(m14480id = 5) boolean z3, @SafeParcelable.Param(m14480id = 6) String str, @SafeParcelable.Param(m14480id = 7) int i4, @Nullable @SafeParcelable.Param(m14480id = 8) String str2, @Nullable @SafeParcelable.Param(m14480id = 9) com.google.android.gms.common.server.converter.zaa zaaVar) {
            this.zai = i;
            this.zaa = i2;
            this.zab = z2;
            this.zac = i3;
        ...
        @NonNull
        @KeepForSdk
        public static Field withConverter(@NonNull String str, int i, @NonNull FieldConverter<?, ?> fieldConverter, boolean z2) {
            fieldConverter.zaa();
            fieldConverter.zab();
            return new Field(7, z2, 0, false, str, i, null, fieldConverter);
        }
        ...
        public Field(int i, boolean z2, int i2, boolean z3, @NonNull String str, int i3, @Nullable Class<? extends FastJsonResponse> cls, @Nullable FieldConverter<I, O> fieldConverter) {
            this.zai = 1;
            this.zaa = i;
            this.zab = z2;
            this.zac = i2;
