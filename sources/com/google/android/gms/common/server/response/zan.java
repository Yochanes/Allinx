...
public final class zan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getRootClassName", m14479id = 3)
    private final String zac;

    @SafeParcelable.Constructor
    public zan(@SafeParcelable.Param(m14480id = 1) int i, @SafeParcelable.Param(m14480id = 2) ArrayList<zal> arrayList, @SafeParcelable.Param(m14480id = 3) String str) {
        this.zaa = i;
