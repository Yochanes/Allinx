...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUrl", m14479id = 2)
    private final Uri zab;

    @SafeParcelable.Field(getter = "getWidth", m14479id = 3)
    private final int zac;

    @SafeParcelable.Field(getter = "getHeight", m14479id = 4)
    private final int zad;

    @SafeParcelable.Constructor
    public WebImage(@SafeParcelable.Param(m14480id = 1) int i, @SafeParcelable.Param(m14480id = 2) Uri uri, @SafeParcelable.Param(m14480id = 3) int i2, @SafeParcelable.Param(m14480id = 4) int i3) {
        this.zaa = i;
        this.zab = uri;
        this.zac = i2;
        this.zad = i3;
    ...
    public String toString() {
        ...
        StringBuilder sbM24u = AbstractC0000a.m24u("Image ", "x", " ", i, i2);
        sbM24u.append(string);
