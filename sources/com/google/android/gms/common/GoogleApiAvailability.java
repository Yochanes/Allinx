...
import com.google.android.gms.base.C3725R;
...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void setDefaultNotificationChannelId(@NonNull Context context, @NonNull String str) {
        if (PlatformVersion.isAtLeastO()) {
            Preconditions.checkNotNull(AbstractC5852a.m16773g((NotificationManager) Preconditions.checkNotNull(context.getSystemService("notification")), str));
        }
        synchronized (zaa) {
            this.zac = str;
        }
    ...
    public final Dialog zaa(@NonNull Context context, int i, zag zagVar, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        Log.w("GoogleApiAvailability", AbstractC0000a.m9f(i, "Creating dialog for Google Play services availability issue. ConnectionResult="), new IllegalArgumentException());
    ...
    public final void zae(Context context, int i, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        String str2;
        int i2;
        Log.w("GoogleApiAvailability", AbstractC0000a.m10g(i, "GMS core API Availability. ConnectionResult=", ", tag=null"), new IllegalArgumentException());
        if (i == 18) {
            zaf(context);
            return;
        }
        ...
        builder.f23028s = true;
        builder.m7429c(16, true);
        builder.f23014e = NotificationCompat.Builder.m7427b(strZaf);
        NotificationCompat.BigTextStyle bigTextStyle = new NotificationCompat.BigTextStyle();
        bigTextStyle.f23000e = NotificationCompat.Builder.m7427b(strZae);
        builder.m7432f(bigTextStyle);
        if (DeviceProperties.isWearable(context)) {
            Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
            builder.f23007B.icon = context.getApplicationInfo().icon;
            builder.f23019j = 2;
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                int i3 = C3725R.drawable.common_full_open_on_phone;
                String string = resources.getString(C3725R.string.common_open_on_phone);
                builder.f23011b.add(new NotificationCompat.Action(i3 != 0 ? IconCompat.m7614d(null, "", i3) : null, string, pendingIntent, new Bundle(), null, null, true, true, false));
            } else {
                builder.f23016g = pendingIntent;
            }
        } else {
            builder.f23007B.icon = android.R.drawable.stat_sys_warning;
            builder.f23007B.tickerText = NotificationCompat.Builder.m7427b(resources.getString(C3725R.string.common_google_play_services_notification_ticker));
            builder.f23007B.when = System.currentTimeMillis();
            builder.f23016g = pendingIntent;
            builder.f23015f = NotificationCompat.Builder.m7427b(strZae);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                NotificationChannel notificationChannelM12759b = AbstractC2433a.m12759b(notificationManager);
                String strZab = com.google.android.gms.common.internal.zac.zab(context);
                if (notificationChannelM12759b == null) {
                    AbstractC2433a.m12776s(notificationManager, AbstractC2433a.m12755B(strZab));
                } else if (!strZab.contentEquals(AbstractC2433a.m12761d(notificationChannelM12759b))) {
                    AbstractC2433a.m12775r(notificationChannelM12759b, strZab);
                    AbstractC2433a.m12776s(notificationManager, notificationChannelM12759b);
                }
            }
            builder.f23032w = str2;
        }
        Notification notificationM7428a = builder.m7428a();
        if (i == 1 || i == 2 || i == 3) {
        ...
        notificationManager.notify(i2, notificationM7428a);
    }
