...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getType", m14479id = 2)
    private int zab;

    @SafeParcelable.Field(getter = "getBundle", m14479id = 3)
    private Bundle zac;

    @SafeParcelable.Constructor
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(m14480id = 1) int i, @SafeParcelable.Param(m14480id = 2) int i2, @SafeParcelable.Param(m14480id = 3) Bundle bundle) {
        this.zaa = i;
        this.zab = i2;
        this.zac = bundle;
    }
