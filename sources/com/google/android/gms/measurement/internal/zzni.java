...
public final class zzni {
    ...
    public final Bundle zza() {
        ...
        String str2 = "denied";
        if (str.length() > 0) {
            bundle.putString(zzjc.zza.AD_STORAGE.zze, str.charAt(0) == '1' ? "granted" : "denied");
        }
        if (str.length() > 3) {
            bundle.putString(zzjc.zza.AD_PERSONALIZATION.zze, (str.charAt(2) == '1' && str.charAt(3) == '1') ? "granted" : "denied");
        }
        if (str.length() > 6 && iZze >= 4) {
            String str3 = zzjc.zza.AD_USER_DATA.zze;
