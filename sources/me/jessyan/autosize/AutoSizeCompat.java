...
public final class AutoSizeCompat {
    ...
    /* JADX INFO: compiled from: Proguard */
    public static /* synthetic */ class C63491 {
    ...
    public static void autoConvertDensity(Resources resources, float f, boolean z2) {
        float density;
        int densityDpi;
        float scaledDensity;
        float xdpi;
    ...
    public static void cancelAdapt(Resources resources) {
        ...
        int i = C63491.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i != 1) {
            f = i == 2 ? 25.4f : 72.0f;
    ...
    private static void setDensity(DisplayMetrics displayMetrics, float f, int i, float f2, float f3) {
        ...
        int i2 = C63491.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i2 == 1) {
