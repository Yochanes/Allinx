    ...
    public void applyAdapt(Object obj, Activity activity) {
        if (AutoSizeConfig.getInstance().getExternalAdaptManager().isRun()) {
            if (AutoSizeConfig.getInstance().getExternalAdaptManager().isCancelAdapt(obj.getClass())) {
                ...
                AutoSizeLog.m21169w(obj.getClass().getName().concat(" canceled the adaptation!"));
            ...
            if (externalAdaptInfoOfActivity != null) {
                ...
                AutoSizeLog.m21167d(obj.getClass().getName() + " used " + ExternalAdaptInfo.class.getName() + " for adaptation!");
        ...
        if (!(obj instanceof CustomAdapt)) {
            ...
            AutoSizeLog.m21167d(obj.getClass().getName().concat(" used the global configuration."));
            AutoSize.autoConvertDensityOfGlobal(activity);
            return;
        }
        Locale locale5 = Locale.ENGLISH;
        AutoSizeLog.m21167d(obj.getClass().getName() + " implemented by " + CustomAdapt.class.getName() + "!");
