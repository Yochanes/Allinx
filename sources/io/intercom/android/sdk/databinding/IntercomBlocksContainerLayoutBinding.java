...
public final class IntercomBlocksContainerLayoutBinding implements ViewBinding {
    ...
    public /* bridge */ /* synthetic */ View getRoot() {
        return m22062getRoot();
    }

    @NonNull
    public static IntercomBlocksContainerLayoutBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z2) {
        View viewInflate = layoutInflater.inflate(C5101R.layout.intercom_blocks_container_layout, viewGroup, false);
        if (z2) {
    ...
    public LinearLayout m22062getRoot() {
