...
/* JADX INFO: renamed from: io.intercom.android.sdk.ui.preview.ui.PreviewBottomBarKt$ThumbnailList$lambda$8$$inlined$itemsIndexed$default$1 */
...
public final class C5815x442a4fe4 extends Lambda implements Function1<Integer, Object> {
    final /* synthetic */ List $items;
    final /* synthetic */ Function2 $key;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C5815x442a4fe4(Function2 function2, List list) {
        super(1);
        this.$key = function2;
        this.$items = list;
    }
