...
public final class CookieUtilsKt$tryParseDayOfMonth$2 extends Lambda implements Function1<Character, Boolean> {
    ...
    public static final CookieUtilsKt$tryParseDayOfMonth$2 f45623a = new CookieUtilsKt$tryParseDayOfMonth$2(1);

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        char cCharValue = ((Character) obj).charValue();
        return Boolean.valueOf(cCharValue >= 0 && 255 >= cCharValue);
    }
}
