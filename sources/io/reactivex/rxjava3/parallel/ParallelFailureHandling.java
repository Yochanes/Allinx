...
public final class ParallelFailureHandling implements BiFunction<Long, Throwable, ParallelFailureHandling> {
    ...
    public static final /* synthetic */ ParallelFailureHandling[] f51263a = {new ParallelFailureHandling("STOP", 0), new ParallelFailureHandling("ERROR", 1), new ParallelFailureHandling("SKIP", 2), new ParallelFailureHandling("RETRY", 3)};
    ...
    public static ParallelFailureHandling[] values() {
        return (ParallelFailureHandling[]) f51263a.clone();
    }
}
