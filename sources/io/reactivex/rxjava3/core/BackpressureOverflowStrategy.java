...
public final class BackpressureOverflowStrategy {
    ...
    public static final /* synthetic */ BackpressureOverflowStrategy[] f49357a = {new BackpressureOverflowStrategy("ERROR", 0), new BackpressureOverflowStrategy("DROP_OLDEST", 1), new BackpressureOverflowStrategy("DROP_LATEST", 2)};
    ...
    public static BackpressureOverflowStrategy[] values() {
        return (BackpressureOverflowStrategy[]) f49357a.clone();
    }
}
