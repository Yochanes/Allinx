...
public final class MaybeContains<T> extends Single<Boolean> implements HasUpstreamMaybeSource<T> {
    ...
    public static final class ContainsMaybeObserver implements MaybeObserver<Object>, Disposable {
        ...
        public Disposable f50189a;

        @Override // io.reactivex.rxjava3.core.MaybeObserver
        /* JADX INFO: renamed from: c */
        public final void mo12364c(Disposable disposable) {
            if (DisposableHelper.m17956f(this.f50189a, disposable)) {
                this.f50189a = disposable;
                throw null;
            }
        }
        ...
        public final boolean mo12353d() {
            return this.f50189a.mo12353d();
        }

        @Override // io.reactivex.rxjava3.disposables.Disposable
        public final void dispose() {
            this.f50189a.dispose();
            this.f50189a = DisposableHelper.f49380a;
        }
