...
public final class MaybeFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    public static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements MaybeObserver<T> {
        ...
        public final FlowableSubscriber f50222a;

        /* JADX INFO: renamed from: b */
        public final AtomicLong f50223b = new AtomicLong();

        /* JADX INFO: renamed from: c */
        public Disposable f50224c;

        /* JADX INFO: renamed from: d */
        public volatile Iterator f50225d;
        ...
        public FlatMapIterableObserver(FlowableSubscriber flowableSubscriber) {
            this.f50222a = flowableSubscriber;
        }

        @Override // io.reactivex.rxjava3.core.MaybeObserver
        /* JADX INFO: renamed from: c */
        public final void mo12364c(Disposable disposable) {
            if (DisposableHelper.m17956f(this.f50224c, disposable)) {
                this.f50224c = disposable;
                this.f50222a.mo12367j(this);
            }
        }
        ...
        public final void cancel() {
            this.f50226f = true;
            this.f50224c.dispose();
            this.f50224c = DisposableHelper.f49380a;
        }
        ...
        public final void request(long j) {
            ...
            BackpressureHelper.m18237a(this.f50223b, j);
            if (getAndIncrement() != 0) {
                return;
            }
            FlowableSubscriber flowableSubscriber = this.f50222a;
            Iterator it = this.f50225d;
            if (this.f50227g && it != null) {
            ...
            while (true) {
                if (it != null) {
                    ...
                    if (j3 != 0) {
                        BackpressureHelper.m18241e(this.f50223b, j3);
                    }
                }
