...
public final class MaybeFromSingle<T> extends Maybe<T> implements HasUpstreamSingleSource<T> {
    ...
    public static final class FromSingleObserver<T> implements SingleObserver<T>, Disposable {
        ...
        public Disposable f50237a;

        @Override // io.reactivex.rxjava3.core.SingleObserver
        /* JADX INFO: renamed from: c */
        public final void mo12366c(Disposable disposable) {
            if (DisposableHelper.m17956f(this.f50237a, disposable)) {
                this.f50237a = disposable;
                throw null;
            }
        }
        ...
        public final boolean mo12353d() {
            return this.f50237a.mo12353d();
        }

        @Override // io.reactivex.rxjava3.disposables.Disposable
        public final void dispose() {
            this.f50237a.dispose();
            this.f50237a = DisposableHelper.f49380a;
        }
