...
public final class MaybeHide<T> extends AbstractMaybeWithUpstream<T, T> {
    ...
    public static final class HideMaybeObserver<T> implements MaybeObserver<T>, Disposable {
        ...
        public Disposable f50238a;

        @Override // io.reactivex.rxjava3.core.MaybeObserver
        /* JADX INFO: renamed from: c */
        public final void mo12364c(Disposable disposable) {
            if (DisposableHelper.m17956f(this.f50238a, disposable)) {
                this.f50238a = disposable;
                throw null;
            }
        }
        ...
        public final boolean mo12353d() {
            return this.f50238a.mo12353d();
        }

        @Override // io.reactivex.rxjava3.disposables.Disposable
        public final void dispose() {
            this.f50238a.dispose();
            this.f50238a = DisposableHelper.f49380a;
        }
