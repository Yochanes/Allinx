...
public final class MaybeFlatMapNotification<T, R> extends AbstractMaybeWithUpstream<T, R> {
    ...
    public static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public final MaybeObserver f50231a;

        /* JADX INFO: renamed from: b */
        public Disposable f50232b;
        ...
        public FlatMapMaybeObserver(MaybeObserver maybeObserver) {
            this.f50231a = maybeObserver;
        }

        @Override // io.reactivex.rxjava3.core.MaybeObserver
        /* JADX INFO: renamed from: c */
        public final void mo12364c(Disposable disposable) {
            if (DisposableHelper.m17956f(this.f50232b, disposable)) {
                this.f50232b = disposable;
                this.f50231a.mo12364c(this);
            }
        }
        ...
        public final void onError(Throwable th) {
            try {
                ...
                this.f50231a.onError(new CompositeException(th, th2));
            }
        }
