...
public final class MaybeTimeoutMaybe<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    public static final class TimeoutMainMaybeObserver<T, U> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public final MaybeObserver f50265a;

        /* JADX INFO: renamed from: b */
        public final TimeoutOtherMaybeObserver f50266b = new TimeoutOtherMaybeObserver(this);

        /* JADX INFO: renamed from: c */
        public final TimeoutFallbackMaybeObserver f50267c = null;

        public TimeoutMainMaybeObserver(MaybeObserver maybeObserver) {
            this.f50265a = maybeObserver;
        }
        ...
        public final void dispose() {
            ...
            DisposableHelper.m17952a(this.f50266b);
            TimeoutFallbackMaybeObserver timeoutFallbackMaybeObserver = this.f50267c;
    ...
    public static final class TimeoutOtherMaybeObserver<T, U> extends AtomicReference<Disposable> implements MaybeObserver<Object> {
        ...
        /* JADX INFO: renamed from: a */
        public final TimeoutMainMaybeObserver f50268a;

        public TimeoutOtherMaybeObserver(TimeoutMainMaybeObserver timeoutMainMaybeObserver) {
            this.f50268a = timeoutMainMaybeObserver;
        }
        ...
        @Override // io.reactivex.rxjava3.core.MaybeObserver
        public final void onComplete() {
            TimeoutMainMaybeObserver timeoutMainMaybeObserver = this.f50268a;
            timeoutMainMaybeObserver.getClass();
            if (DisposableHelper.m17952a(timeoutMainMaybeObserver)) {
                timeoutMainMaybeObserver.f50265a.onError(new TimeoutException());
            }
        }
        ...
        public final void onError(Throwable th) {
            ...
            timeoutMainMaybeObserver.getClass();
            if (DisposableHelper.m17952a(timeoutMainMaybeObserver)) {
                timeoutMainMaybeObserver.f50265a.onError(th);
            } else {
                RxJavaPlugins.m18275b(th);
            }
        }
