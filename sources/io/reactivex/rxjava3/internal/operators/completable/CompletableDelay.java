...
public final class CompletableDelay extends Completable {
    ...
    public static final class Delay extends AtomicReference<Disposable> implements CompletableObserver, Runnable, Disposable {
        ...
        public final CompletableObserver f49517a;

        /* JADX INFO: renamed from: b */
        public Throwable f49518b;

        public Delay(CompletableObserver completableObserver) {
            this.f49517a = completableObserver;
        }
        ...
        public final void run() {
            Throwable th = this.f49518b;
            this.f49518b = null;
            CompletableObserver completableObserver = this.f49517a;
            if (th != null) {
