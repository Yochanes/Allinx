...
public final class FlowableAllSingle<T> extends Single<Boolean> implements FuseToFlowable<Boolean> {
    ...
    public static final class AllSubscriber<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public final boolean mo17596d() {
            return this.f47652a == SubscriptionHelper.f49266a;
        }

        @Override // io.reactivex.disposables.Disposable
        public final void dispose() {
            this.f47652a.cancel();
            this.f47652a = SubscriptionHelper.f49266a;
        }

        @Override // org.reactivestreams.Subscriber
        /* JADX INFO: renamed from: j */
        public final void mo12367j(Subscription subscription) {
            if (SubscriptionHelper.m17874i(this.f47652a, subscription)) {
                this.f47652a = subscription;
                throw null;
            }
        }
        ...
        public final void onNext(Object obj) {
            ...
            try {
                ...
                this.f47652a.cancel();
                this.f47652a = subscriptionHelper;
                onError(th);
            }
        }
    }
