...
public final class MaybeFlatten<T, R> extends AbstractMaybeWithUpstream<T, R> {
    ...
    public static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public final MaybeObserver f48341a;

        /* JADX INFO: renamed from: b */
        public Disposable f48342b;
        ...
        public FlatMapMaybeObserver(MaybeObserver maybeObserver) {
            this.f48341a = maybeObserver;
        }

        @Override // io.reactivex.MaybeObserver
        /* JADX INFO: renamed from: c */
        public final void mo17586c(Disposable disposable) {
            if (DisposableHelper.m17620h(this.f48342b, disposable)) {
                this.f48342b = disposable;
                this.f48341a.mo17586c(this);
            }
        }
