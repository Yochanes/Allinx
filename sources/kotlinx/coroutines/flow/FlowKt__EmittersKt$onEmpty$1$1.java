    ...
    */
    public final Object emit(Object obj, Continuation continuation) {
        ...
        if (continuation instanceof FlowKt__EmittersKt$onEmpty$1$1$emit$1) {
            ...
            int i = flowKt__EmittersKt$onEmpty$1$1$emit$1.f55837c;
            if ((i & Integer.MIN_VALUE) != 0) {
                flowKt__EmittersKt$onEmpty$1$1$emit$1.f55837c = i - Integer.MIN_VALUE;
            } else {
                flowKt__EmittersKt$onEmpty$1$1$emit$1 = new FlowKt__EmittersKt$onEmpty$1$1$emit$1(this, continuation);
            }
        }
        Object obj2 = flowKt__EmittersKt$onEmpty$1$1$emit$1.f55835a;
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.f51584a;
        int i2 = flowKt__EmittersKt$onEmpty$1$1$emit$1.f55837c;
        if (i2 == 0) {
