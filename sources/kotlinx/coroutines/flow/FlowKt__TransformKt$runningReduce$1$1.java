    ...
    */
    public final Object emit(Object obj, Continuation continuation) {
        ...
        if (continuation instanceof FlowKt__TransformKt$runningReduce$1$1$emit$1) {
            ...
            int i = flowKt__TransformKt$runningReduce$1$1$emit$1.f56081c;
            if ((i & Integer.MIN_VALUE) != 0) {
                flowKt__TransformKt$runningReduce$1$1$emit$1.f56081c = i - Integer.MIN_VALUE;
            } else {
                flowKt__TransformKt$runningReduce$1$1$emit$1 = new FlowKt__TransformKt$runningReduce$1$1$emit$1(this, continuation);
            }
        }
        Object obj2 = flowKt__TransformKt$runningReduce$1$1$emit$1.f56079a;
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.f51584a;
        int i2 = flowKt__TransformKt$runningReduce$1$1$emit$1.f56081c;
        if (i2 == 0) {
