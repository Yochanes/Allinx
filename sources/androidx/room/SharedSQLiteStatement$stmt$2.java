...
@Metadata(m18301d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, m18302d2 = {"<anonymous>", "Landroidx/sqlite/db/SupportSQLiteStatement;", "invoke"}, m18303k = 3, m18304mv = {1, 8, 0}, m18306xi = 48)
final class SharedSQLiteStatement$stmt$2 extends Lambda implements Function0<SupportSQLiteStatement> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ SharedSQLiteStatement f31991a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SharedSQLiteStatement$stmt$2(SharedSQLiteStatement sharedSQLiteStatement) {
        super(0);
        this.f31991a = sharedSQLiteStatement;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        return this.f31991a.m11846b();
    }
}
