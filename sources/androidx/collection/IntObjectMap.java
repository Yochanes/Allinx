...
@Metadata(m18301d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\b6\u0018\u0000*\u0004\b\u0000\u0010\u00012\u00020\u0002\u0082\u0001\u0001\u0003¨\u0006\u0004"}, m18302d2 = {"Landroidx/collection/IntObjectMap;", "V", "", "Landroidx/collection/MutableIntObjectMap;", "collection"}, m18303k = 1, m18304mv = {1, 9, 0}, m18306xi = 48)
...
public abstract class IntObjectMap<V> {
    ...
    */
    public final boolean m1991a(int i) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m1992b(int i) {
        int iNumberOfTrailingZeros;
        int iHashCode = Integer.hashCode(i) * (-862048943);
        int i2 = iHashCode ^ (iHashCode << 16);
        int i3 = i2 & 127;
        ...
        if (iNumberOfTrailingZeros >= 0) {
            return this.f3683c[iNumberOfTrailingZeros];
        }
        return null;
    }
    ...
    */
    public final boolean equals(Object obj) {
        ...
        if (intObjectMap.f3685e != this.f3685e) {
            return false;
        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            ...
                            if (obj2 == null) {
                                if (intObjectMap.m1992b(i5) != null || !intObjectMap.m1991a(i5)) {
                                    break loop0;
                                }
                            } else if (!obj2.equals(intObjectMap.m1992b(i5))) {
                                return false;
                            }
                        }
                        j >>= 8;
