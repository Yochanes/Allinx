...
class EdgeToEdgeApi29 extends EdgeToEdgeApi28 {
    ...
    public void mo156a(@NotNull SystemBarStyle statusBarStyle, @NotNull SystemBarStyle navigationBarStyle, @NotNull Window window, @NotNull View view, boolean statusBarIsDark, boolean navigationBarIsDark) {
        ...
        window.setStatusBarColor(statusBarStyle.f118c == 0 ? 0 : statusBarIsDark ? statusBarStyle.f117b : statusBarStyle.f116a);
        int i = navigationBarStyle.f118c;
        window.setNavigationBarColor(i == 0 ? 0 : navigationBarIsDark ? navigationBarStyle.f117b : navigationBarStyle.f116a);
        AbstractC0020a.m51e(window);
        AbstractC0020a.m52f(window, i == 0);
        WindowInsetsControllerCompat windowInsetsControllerCompat = new WindowInsetsControllerCompat(window, view);
        windowInsetsControllerCompat.m7957f(!statusBarIsDark);
        windowInsetsControllerCompat.m7956e(true ^ navigationBarIsDark);
    }
}
