...
public class MonotonicCurveFit extends CurveFit {
    ...
    public final double[] f21455a;

    /* JADX INFO: renamed from: b */
    public final double[][] f21456b;
    ...
    public MonotonicCurveFit(double[] dArr, double[][] dArr2) {
        ...
        this.f21458d = new double[length2];
        int i = length - 1;
    ...
    public static double m6914h(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d2 * 6.0d;
    ...
    public static double m6915i(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d7 * d2;
        double d9 = 3.0d * d7;
    ...
    public final double mo6885b(double d) {
        ...
        double d3;
        double dMo6888e;
        double[] dArr = this.f21455a;
        int length = dArr.length;
        double d4 = dArr[0];
        double[][] dArr2 = this.f21456b;
        if (d <= d4) {
            d2 = dArr2[0][0];
            d3 = d - d4;
            dMo6888e = mo6888e(d4);
            ...
            if (d < d5) {
                ...
                while (i2 < i) {
                    ...
                    if (d < d7) {
                        ...
                        double[][] dArr3 = this.f21457c;
                        return m6915i(d8, d9, d10, d11, dArr3[i2][0], dArr3[i3][0]);
                    }
                    i2 = i3;
                }
                return 0.0d;
    ...
    public final void mo6886c(double d, double[] dArr) {
        double[] dArr2 = this.f21455a;
        int length = dArr2.length;
        double[][] dArr3 = this.f21456b;
        int i = 0;
        int length2 = dArr3[0].length;
        double d2 = dArr2[0];
        double[] dArr4 = this.f21458d;
        if (d <= d2) {
            mo6889f(d2, dArr4);
            for (int i2 = 0; i2 < length2; i2++) {
        ...
        while (i4 < length - 1) {
            ...
            if (d < d4) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr5 = this.f21457c;
                    dArr[i] = m6915i(d6, d7, d8, d9, dArr5[i4][i], dArr5[i6][i]);
                    i++;
                }
                return;
            }
        ...
        while (i4 < length - 1) {
            ...
            if (d < d4) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr4 = this.f21457c;
                    fArr[i] = (float) m6915i(d6, d7, d8, d9, dArr4[i4][i], dArr4[i6][i]);
                    i++;
                }
                return;
            }
    ...
    public final double mo6888e(double d) {
        ...
        while (i < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                double[][] dArr3 = this.f21457c;
                return m6914h(d5, (d2 - d4) / d5, d6, d7, dArr3[i][0], dArr3[i2][0]) / d5;
            }
            i = i2;
        }
        return 0.0d;
        ...
        while (i < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                for (int i3 = 0; i3 < length2; i3++) {
                    ...
                    double[][] dArr4 = this.f21457c;
                    dArr[i3] = m6914h(d5, d6, d7, d8, dArr4[i][i3], dArr4[i2][i3]) / d5;
                }
                return;
            }
            i = i2;
