...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public final void mapProperties(PropertyMapper propertyMapper) {
            this.f1121a = AbstractC0020a.m48b(propertyMapper);
            this.f1122b = AbstractC0020a.m60n(propertyMapper);
            this.f1123c = AbstractC0020a.m63q(propertyMapper);
            this.f1124d = AbstractC0020a.m64r(propertyMapper);
        }

        public final void readProperties(Object obj, PropertyReader propertyReader) {
            AppCompatImageButton appCompatImageButton = (AppCompatImageButton) obj;
            AbstractC0020a.m54h(propertyReader, this.f1121a, appCompatImageButton.getBackgroundTintList());
            AbstractC0020a.m55i(propertyReader, this.f1122b, appCompatImageButton.getBackgroundTintMode());
            AbstractC0020a.m54h(propertyReader, this.f1123c, appCompatImageButton.getImageTintList());
            AbstractC0020a.m55i(propertyReader, this.f1124d, appCompatImageButton.getImageTintMode());
        }
    }
