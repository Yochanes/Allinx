...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f1242c = -1;
        int[] iArr = R.styleable.f272k;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr);
        ViewCompat.m7807z(this, context, iArr, attributeSet, typedArrayObtainStyledAttributes, 0);
        this.f1240a = typedArrayObtainStyledAttributes.getBoolean(0, true);
        typedArrayObtainStyledAttributes.recycle();
        if (getOrientation() == 1) {
            setStacked(this.f1240a);
        }
    }
    ...
    private void setStacked(boolean z2) {
        if (this.f1241b != z2) {
            if (!z2 || this.f1240a) {
                ...
                View viewFindViewById = findViewById(com.exchange.allin.R.id.spacer);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int paddingBottom = 0;
        if (this.f1240a) {
            if (size > this.f1242c && this.f1241b) {
                setStacked(false);
            }
            this.f1242c = size;
        }
        if (this.f1241b || View.MeasureSpec.getMode(i) != 1073741824) {
            iMakeMeasureSpec = i;
            z2 = false;
        } else {
        ...
        if (this.f1240a && !this.f1241b && (getMeasuredWidthAndState() & (-16777216)) == 16777216) {
            setStacked(true);
            z2 = true;
        }
        if (z2) {
