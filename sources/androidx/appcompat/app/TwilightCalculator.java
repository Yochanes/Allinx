...
class TwilightCalculator {
    ...
    public static TwilightCalculator f529d;
    ...
    /* JADX INFO: renamed from: a */
    public final void m340a(double d, double d2, long j) {
        ...
        if (dSin3 >= 1.0d) {
            ...
            this.f530a = Math.round((dSin2 + dAcos) * 8.64E7d) + 946728000000L;
            long jRound = Math.round((dSin2 - dAcos) * 8.64E7d) + 946728000000L;
            this.f531b = jRound;
            if (jRound >= j || this.f530a <= j) {
                this.f532c = 1;
            } else {
                this.f532c = 0;
            }
