...
final class ExposedDropdownMenuBoxScope$ExposedDropdownMenu$1$1 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MutableState f13326a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ExposedDropdownMenuBoxScope$ExposedDropdownMenu$1$1(MutableState mutableState) {
        super(0);
        this.f13326a = mutableState;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        Unit unit = Unit.f51459a;
        this.f13326a.setValue(unit);
        return unit;
    }
}
