...
final class ChipKt$InputChip$1$1$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    ...
    public final /* synthetic */ Shape f12489b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChipKt$InputChip$1$1$1(Shape shape, float f) {
        super(1);
        this.f12488a = f;
        this.f12489b = shape;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        graphicsLayerScope.mo5213b(this.f12488a);
        graphicsLayerScope.mo5212R0(this.f12489b);
        graphicsLayerScope.mo5210E(true);
        return Unit.f51459a;
    }
}
