...
final class ExposedDropdownMenu_androidKt$ExposedDropdownMenuBox$5$1 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ Function1 f13380a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ExposedDropdownMenu_androidKt$ExposedDropdownMenuBox$5$1(Function1 function1) {
        super(0);
    ...
    public final Object invoke() {
        this.f13380a.invoke(Boolean.FALSE);
        return Unit.f51459a;
    }
}
