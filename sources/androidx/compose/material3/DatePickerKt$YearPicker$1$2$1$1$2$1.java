...
final class DatePickerKt$YearPicker$1$2$1$1$2$1 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ Function1 f13062a;

    /* JADX INFO: renamed from: b */
    public final /* synthetic */ int f13063b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DatePickerKt$YearPicker$1$2$1$1$2$1(Function1 function1, int i) {
        super(0);
    ...
    public final Object invoke() {
        this.f13062a.invoke(Integer.valueOf(this.f13063b));
        return Unit.f51459a;
    }
}
