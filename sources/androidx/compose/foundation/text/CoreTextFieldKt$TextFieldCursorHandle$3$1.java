...
final class CoreTextFieldKt$TextFieldCursorHandle$3$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    public CoreTextFieldKt$TextFieldCursorHandle$3$1(long j) {
        super(1);
        this.f8393a = j;
    }
    ...
    public final Object invoke(Object obj) {
        ((SemanticsPropertyReceiver) obj).mo6263c(SelectionHandlesKt.f9779c, new SelectionHandleInfo(Handle.f8401a, this.f8393a, SelectionHandleAnchor.f9769b, true));
        return Unit.f51459a;
    }
}
