...
final class AndroidSelectionHandles_androidKt$SelectionHandle$1$1$1$1$1 extends Lambda implements Function0<Boolean> {
    ...
    public final /* synthetic */ OffsetProvider f9580a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AndroidSelectionHandles_androidKt$SelectionHandle$1$1$1$1$1(OffsetProvider offsetProvider) {
        super(0);
        this.f9580a = offsetProvider;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        return Boolean.valueOf((this.f9580a.mo3207a() & 9223372034707292159L) != 9205357640488583168L);
    }
}
