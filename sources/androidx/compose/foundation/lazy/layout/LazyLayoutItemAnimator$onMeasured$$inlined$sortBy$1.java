...
public final class LazyLayoutItemAnimator$onMeasured$$inlined$sortBy$1<T> implements Comparator {
    ...
    public final /* synthetic */ LazyLayoutKeyIndexMap f7283a;

    public LazyLayoutItemAnimator$onMeasured$$inlined$sortBy$1(LazyLayoutKeyIndexMap lazyLayoutKeyIndexMap) {
        this.f7283a = lazyLayoutKeyIndexMap;
    }

    @Override // java.util.Comparator
    public final int compare(Object obj, Object obj2) {
        Object key = ((LazyLayoutMeasuredItem) obj).getKey();
        LazyLayoutKeyIndexMap lazyLayoutKeyIndexMap = this.f7283a;
        return ComparisonsKt.m18545a(Integer.valueOf(lazyLayoutKeyIndexMap.mo3060c(key)), Integer.valueOf(lazyLayoutKeyIndexMap.mo3060c(((LazyLayoutMeasuredItem) obj2).getKey())));
    }
}
