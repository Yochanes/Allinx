...
final class BottomNavigationKt$placeIcon$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final /* synthetic */ Placeable f10248a;
    ...
    public BottomNavigationKt$placeIcon$1(Placeable placeable, int i) {
        super(1);
        this.f10248a = placeable;
        this.f10249b = i;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        Placeable.PlacementScope.m5677h((Placeable.PlacementScope) obj, this.f10248a, 0, this.f10249b);
        return Unit.f51459a;
    }
}
