...
public final class ComposableSingletons$TabRowKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public static final ComposableSingletons$TabRowKt$lambda2$1 f10408a = new ComposableSingletons$TabRowKt$lambda2$1(2);
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if (composer.mo4212E(iIntValue & 1, (iIntValue & 3) != 2)) {
            TabRowDefaults.f11454a.m3803a(null, 0.0f, 0L, composer, 3072);
        } else {
            composer.mo4246x();
        }
        return Unit.f51459a;
