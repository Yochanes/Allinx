...
final class MinimumInteractiveComponentSizeModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final /* synthetic */ Placeable f10707b;
    ...
    public MinimumInteractiveComponentSizeModifier$measure$1(int i, int i2, Placeable placeable) {
        super(1);
        this.f10706a = i;
        this.f10707b = placeable;
        this.f10708c = i2;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        Placeable.PlacementScope.m5675f((Placeable.PlacementScope) obj, this.f10707b, MathKt.m18640b((this.f10706a - r0.f18567a) / 2.0f), MathKt.m18640b((this.f10708c - r0.f18568b) / 2.0f));
        return Unit.f51459a;
    }
}
