...
final class AndroidUiFrameClock$withFrameNanos$2$2 extends Lambda implements Function1<Throwable, Unit> {
    ...
    public final /* synthetic */ AndroidUiFrameClock f19304a;

    /* JADX INFO: renamed from: b */
    public final /* synthetic */ Choreographer.FrameCallback f19305b;
    ...
    public AndroidUiFrameClock$withFrameNanos$2$2(AndroidUiFrameClock androidUiFrameClock, Choreographer.FrameCallback frameCallback) {
        super(1);
        this.f19304a = androidUiFrameClock;
        this.f19305b = frameCallback;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        this.f19304a.f19300a.removeFrameCallback(this.f19305b);
        return Unit.f51459a;
    }
}
