...
public final class ViewFactoryHolder$updateBlock$1 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ ViewFactoryHolder f20690a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ViewFactoryHolder$updateBlock$1(ViewFactoryHolder viewFactoryHolder) {
        super(0);
        this.f20690a = viewFactoryHolder;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        ViewFactoryHolder viewFactoryHolder = this.f20690a;
        viewFactoryHolder.getUpdateBlock().invoke(viewFactoryHolder.f20680F);
        return Unit.f51459a;
    }
}
