...
final class ApproachLayoutModifierNode$measure$1$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ Placeable f18432a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ApproachLayoutModifierNode$measure$1$1(Placeable placeable) {
        super(1);
        this.f18432a = placeable;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        Placeable.PlacementScope.m5675f((Placeable.PlacementScope) obj, this.f18432a, 0, 0);
        return Unit.f51459a;
    }
}
