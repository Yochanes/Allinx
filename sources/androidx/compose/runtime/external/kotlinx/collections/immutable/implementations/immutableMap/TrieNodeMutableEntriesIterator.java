...
public final class TrieNodeMutableEntriesIterator<K, V> extends TrieNodeBaseIterator<K, V, Map.Entry<K, V>> {
    ...
    public final Object next() {
        ...
        return new MutableMapEntry(this.f16825d, objArr[i], objArr[i + 1]);
    }
}
