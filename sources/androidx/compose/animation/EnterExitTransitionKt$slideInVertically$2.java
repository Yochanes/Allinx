...
final class EnterExitTransitionKt$slideInVertically$2 extends Lambda implements Function1<IntSize, IntOffset> {
    ...
    public final /* synthetic */ Function1 f4165a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EnterExitTransitionKt$slideInVertically$2(Function1 function1) {
        super(1);
        this.f4165a = function1;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        return new IntOffset((((long) 0) << 32) | (4294967295L & ((long) ((Number) this.f4165a.invoke(Integer.valueOf((int) (((IntSize) obj).f20568a & 4294967295L)))).intValue())));
    }
}
