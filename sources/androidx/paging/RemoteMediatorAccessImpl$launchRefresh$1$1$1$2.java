...
final class RemoteMediatorAccessImpl$launchRefresh$1$1$1$2 extends Lambda implements Function1<AccessorState<Object, Object>, Boolean> {
    ...
    public final /* synthetic */ RemoteMediator.MediatorResult.Error f31227a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RemoteMediatorAccessImpl$launchRefresh$1$1$1$2(RemoteMediator.MediatorResult.Error error) {
        super(1);
        this.f31227a = error;
    }
