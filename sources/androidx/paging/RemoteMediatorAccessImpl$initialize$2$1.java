...
final class RemoteMediatorAccessImpl$initialize$2$1 extends Lambda implements Function1<AccessorState<Object, Object>, Unit> {
    ...
    public static final RemoteMediatorAccessImpl$initialize$2$1 f31207a = new RemoteMediatorAccessImpl$initialize$2$1(1);

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        AccessorState it = (AccessorState) obj;
        Intrinsics.m18599g(it, "it");
        LoadType loadType = LoadType.f30754c;
        AccessorState.BlockState blockState = AccessorState.BlockState.f30526b;
        it.m11317c(loadType, blockState);
        it.m11317c(LoadType.f30753b, blockState);
        return Unit.f51459a;
    }
}
